!(function (e, t) {
  ...
  (C.filter = function (e, t, n) {
    ...
    C.fn.extend({
      ...
      is: function (e) {
        return !!I(this, 'string' == typeof e && S.test(e) ? C(e) : e || [], !1)
          .length;
      },
    });
  var k,
          ...
          s = {
            ...
            then: function (t, n, i) {
              ...
              return C.Deferred(function (e) {
                o[0][3].add(u(0, e, C.isFunction(i) ? i : F, e.notifyWith)),
                  o[1][3].add(u(0, e, C.isFunction(t) ? t : F)),
                  o[2][3].add(u(0, e, C.isFunction(n) ? n : q));
              }).promise();
            },
            promise: function (e) {
  ...
  C.extend({
    ...
    C.fn.extend({
      data: function (n, e) {
        ...
        if (
          this.length &&
          ((r = V.get(o)), 1 === o.nodeType && !Q.get(o, 'hasDataAttrs'))
        ) {
          for (t = s.length; t--; )
            s[t] &&
  ...
  function Oe(n, i, r, o) {
    ...
    if (
      ...
      for (a = (s = C.map(ue(e, 'script'), Ne)).length; c < f; c++)
        (l = e),
          c !== h &&
            ((l = C.clone(l, !0, !0)), a && C.merge(s, ue(l, 'script'))),
          r.call(n[c], l, c);
      if (a)
      ...
      if (
        ...
        for (s = ue(c), i = 0, r = (o = ue(e)).length; i < r; i++)
          (a = o[i]),
            (l = s[i]),
            void 0,
            'input' === (u = l.nodeName.toLowerCase()) && oe.test(a.type)
              ? (l.checked = a.checked)
              : ('input' !== u && 'textarea' !== u) ||
                (l.defaultValue = a.defaultValue);
      if (t)
        if (n)
          for (o = o || ue(e), s = s || ue(c), i = 0, r = o.length; i < r; i++)
            ke(o[i], s[i]);
        else ke(e, c);
      return (
        0 < (s = ue(c, 'script')).length && ce(s, !f && ue(e, 'script')), c
      );
    },
    ...
    C.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (C.cleanData(ue(e, !1)), (e.textContent = ''));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < i; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (C.cleanData(ue(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return Oe(
          ...
          function (e) {
            ...
            C.inArray(this, n) < 0 &&
              (C.cleanData(ue(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  function Ve(e, t, n, i, r) {
    ...
    for (
      ...
      'margin' === n && (s += C.css(e, n + Z[o], !0, r)),
        i
          ? ('content' === n && (s -= C.css(e, 'padding' + Z[o], !0, r)),
            'margin' !== n && (s -= C.css(e, 'border' + Z[o] + 'Width', !0, r)))
      ...
      C.cssHooks[s] = {
        ...
        set: function (e, t, n) {
          var i,
            ...
            o =
              n &&
              Ve(e, s, n, 'border-box' === C.css(e, 'boxSizing', !1, r), r);
          return (
            o &&
              (i = J.exec(t)) &&
              'px' !== (i[3] || 'px') &&
  ...
  function st(o, e, t) {
    ...
    for (
      ...
      if ((n = st.prefilters[i].call(u, o, c, u.opts)))
        return (
          C.isFunction(n.stop) &&
            (C._queueHooks(u.elem, u.opts.queue).stop = C.proxy(n.stop, n)),
          n
        );
    return (
      C.map(c, ot, u),
  ...
  (C.Animation = C.extend(st, {
    ...
    tweener: function (e, t) {
      for (
        var n,
          i = 0,
          r = (e = C.isFunction(e) ? ((t = e), ['*']) : e.match(P)).length;
        i < r;
        i++
      )
        (n = e[i]),
        ...
        if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
          ...
          d))
            l ||
              ...
              g && re([e], !0),
              h.done(function () {
                for (i in (g || re([e]), Q.remove(e, 'fxshow'), d))
                  C.style(e, i, d[i]);
              })),
              (l = ot(g ? m[i] : 0, i, h)),
              i in m ||
      ...
      toggleClass: function (r, t) {
        ...
        return 'boolean' == typeof t && 'string' === o
          ...
          : this.each(function () {
              var e, t, n, i;
              if ('string' === o)
                for (t = 0, n = C(this), i = r.match(P) || []; (e = i[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== r && 'boolean' !== o) ||
                  ((e = ht(this)) && Q.set(this, '__className__', e),
                  this.setAttribute &&
                    this.setAttribute(
                      'class',
                      e || !1 === r ? '' : Q.get(this, '__className__') || ''
                    ));
            });
      },
      hasClass: function (e) {
    ...
    trigger: function (e, t, n, i) {
      ...
      if (
        ...
        if (!i && !c.noBubble && !C.isWindow(n)) {
          for (
            a = c.delegateType || h, pt.test(a + h) || (o = o.parentNode);
            o;
            o = o.parentNode
          )
            f.push(o), (s = o);
      ...
      ajax: function (e, t) {
        ...
        if (
          ...
          try {
            (i.href = m.url),
              (i.href = i.href),
              (m.crossDomain =
                Ot.protocol + '//' + Ot.host != i.protocol + '//' + i.host);
          } catch (e) {
            m.crossDomain = !0;
          }
        }
        ...
        m.hasContent
          ...
          : ((o = m.url.slice(f.length)),
            m.data && ((f += (vt.test(f) ? '&' : '?') + m.data), delete m.data),
            !1 === m.cache &&
              ((f = f.replace(Ct, '$1')),
              (o = (vt.test(f) ? '&' : '?') + '_=' + mt++ + o)),
            (m.url = f + o)),
  ...
  C.ajaxSetup({
        ...
        return (
          ...
          n.always(function () {
            void 0 === r ? C(T).removeProp(i) : (T[i] = r),
              e[i] && ((e.jsonpCallback = t.jsonpCallback), Rt.push(i)),
    ...
    C.each(['top', 'left'], function (e, n) {
      C.cssHooks[n] = qe(m.pixelPosition, function (e, t) {
        if (t)
          return (t = Fe(e, n)), He.test(t) ? C(e).position()[n] + 'px' : t;
      });
    }),
      ...
      wt = (function () {
        function o(e, t) {
          ...
          !(function (e, t) {
            ...
            Object.keys($e({}, o.Defaults.modifiers, i.modifiers)).forEach(
              function (e) {
      ...
      Yt = (function () {
        ...
        return (
            ...
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(It),
                  p(n).toggleClass(It).trigger(p.Event(At.SHOWN, e)));
            }
          }),
          (e.hide = function () {
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(It),
                  p(n).toggleClass(It).trigger(p.Event(At.HIDDEN, e)));
            }
          }),
          (e.dispose = function () {
          ...
          (e._getPlacement = function () {
            ...
            return (
              e.hasClass(kt)
                ? ((t = Wt), p(this._menu).hasClass(jt) && (t = Bt))
                : e.hasClass(Ot)
                ? (t = $t)
                : e.hasClass(Lt)
                ? (t = Qt)
            ...
            r.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === vn.indexOf(n) ||
                    Boolean(e.nodeValue.match(_n) || e.nodeValue.match(bn))
                  );
                for (
      ...
      Un = (function () {
        ...
        return (
          ...
          (e.setContent = function () {
            ...
            this.setElementContent(p(e.querySelectorAll(Fn)), this.getTitle()),
        ...
        return (
          ...
          (e._getConfig = function (e) {
            return (
              ...
              g.typeCheckConfig(Wi, e, this.constructor.DefaultType),
              e
            );
          }),
          (e._setListeners = function () {
