!(function (t, e) {
  ...
  !(function (T) {
    ...
    String.prototype.includes ||
      ...
      (e = function (t) {
        ...
        return (
          a != a && (a = 0),
          !(i < n + Math.min(Math.max(a, 0), i)) && -1 != l.call(e, s, a)
        );
      }),
      t
    ...
    T.valHooks.select.set = function (t, e) {
      return (
        e && !n.useDefault && T(t).data('selected', !0),
    ...
    var d = function (e) {
      ...
      c = function (t, e) {
        n.useDefault || ((T.valHooks.select.set = n._set), (n.useDefault = !0)),
          (this.$element = T(t)),
    ...
    (c.VERSION = '1.12.4'),
      ...
      (c.prototype = {
        ...
        createLi: function () {
          ...
          if (
            ...
            (t.className = 'bs-title-option'),
              (t.innerHTML = this.options.title),
              (t.value = ''),
              e.insertBefore(t, e.firstChild),
              void 0 === T(e.options[e.selectedIndex]).attr('selected') &&
            ...
            k.each(function (t) {
              ...
              if ((C++, !e.hasClass('bs-title-option'))) {
                ...
                if (
                  ...
                  return (
                    (i = e.data('prevHiddenIndex')),
                    e.next().data('prevHiddenIndex', void 0 !== i ? i : t),
                    void C--
                  );
                if (
                  (e.data('content') ||
                  ...
                  if (0 === e.index()) {
                    ...
                    (f =
                      ...
                      0 !== t &&
                        0 < y.length &&
                        (C++, y.push(S('', null, 'divider', w + 'div'))),
                      C++,
                      y.push(S(f, null, 'dropdown-header' + g, w));
                  }
                  if (x.options.hideDisabled && c) return void C--;
                  y.push(S($(o, 'opt ' + s + g, n, a), t, '', w));
                } else if (!0 === e.data('divider'))
                  y.push(S('', t, 'divider'));
                else if (!0 === e.data('hidden'))
                  (i = e.data('prevHiddenIndex')),
                    e.next().data('prevHiddenIndex', void 0 !== i ? i : t),
                    y.push(S($(o, s, n, a), t, 'hidden is-hidden'));
                else {
                  var v =
                  ...
                  v && (C++, y.push(S('', null, 'divider', w + 'div'))),
                    y.push(S($(o, s, n, a), t));
                }
                x.liObj[t] = C;
              }
        ...
        render: function (t) {
          ...
          if (
            ...
            if (
              ...
              var r = i.not(
                '[data-divider="true"], [data-hidden="true"]' + e
              ).length;
              o = (
          ...
          null == this.options.title &&
            ...
            this.$button.attr('title', p(T.trim(o.replace(/<[^>]*>?/g, '')))),
            ...
            var u = a.offsetHeight,
              ...
              w = {
                vert:
                  ...
                  parseInt(
                    x ? x.borderBottomWidth : y.css('borderBottomWidth')
                  ),
                horiz:
            ...
            var o,
              ...
              k = function () {
                ...
                u.options.container && !i.is('body')
                  ? (((t = i.offset()).top += parseInt(
                      i.css('borderTopWidth')
                    )),
                    (t.left += parseInt(i.css('borderLeftWidth'))))
                  : (t = { top: 0, left: 0 });
                var s = u.options.windowPadding;
                (h = e.top - t.top - n.scrollTop()),
                  (d = n.height() - h - m - t.top - s[2]),
                  (p = e.left - t.left - n.scrollLeft()),
                  (c = n.width() - p - v - t.left - s[1]),
                  (h -= s[0]),
                  (p -= s[3]);
              };
            if ((k(), 'auto' === this.options.size)) {
              var i = function () {
                ...
                k(),
                  (o = d - $.vert),
                  (a = c - $.horiz),
                  (l = u.options.container
                    ? (g.data('height') || g.data('height', g.height()),
                      (r = g.data('height')),
                      g.data('width') || g.data('width', g.width()),
                      g.data('width'))
                    : ((r = g.height()), g.width())),
                  u.options.dropupAuto &&
                    u.$newElement.toggleClass(
                      'dropup',
                      d < h && o - $.vert < r
                    ),
                  u.$newElement.hasClass('dropup') && (o = h - $.vert),
                  'auto' === u.options.dropdownAlignRight &&
                    g.toggleClass(
                      'dropdown-menu-right',
                      c < p && a - $.horiz < l - v
                    ),
                  (t = 3 < s.length + n.length ? 3 * b + $.vert - 2 : 0),
                  g.css({
                    'max-height': o + 'px',
                    overflow: 'hidden',
              ...
              i(),
                this.$searchbox
                  ...
                  .on('input.getSize propertychange.getSize', i),
                n
              ...
              (o = b * this.options.size + R * t + S.vert),
                (r = u.options.container
                  ? (g.data('height') || g.data('height', g.height()),
                    g.data('height'))
                  : g.height()),
                u.options.dropupAuto &&
        ...
        selectPosition: function () {
          ...
          var e,
            ...
            a = function (t) {
              n.$bsContainer
                .addClass(
                  t.attr('class').replace(/form-control|fit-width/gi, '')
                )
        ...
        setSelected: function (t, e, i) {
          i ||
            (this.togglePlaceholder(), (i = this.findLis().eq(this.liObj[t]))),
        ...
        togglePlaceholder: function () {
          ...
          this.$button.toggleClass(
            ...
            null === t ||
              '' === t ||
              (t.constructor === Array && 0 === t.length)
          );
        },
        tabIndex: function () {
        ...
        clickListener: function () {
          ...
          e.data('spaceSelect', !1),
              ...
              if (y.options.liveSearch || y.multiple) {
                if (!y.multiple) {
                  ...
                  (e =
                    ...
                    y.sizeInfo.liHeight / 2),
                    (y.$menuInner[0].scrollTop = e);
                }
            ...
            this.$menuInner.on('click', 'li a', function (t) {
              ...
              if (
                ...
                !y.multiple || (y.multiple && 1 === y.options.maxOptions)
                  ? y.$button.focus()
                  : y.options.liveSearch && y.$searchbox.focus(),
                  o &&
            ...
            this.$menu.on('click', '.actions-btn', function (t) {
              y.options.liveSearch ? y.$searchbox.focus() : y.$button.focus(),
                t.preventDefault(),
                t.stopPropagation(),
            ...
            this.$element.change(function () {
              y.render(!1),
                y.$element.trigger('changed.bs.select', w),
                (w = null);
            });
        },
              ...
              if (
                ...
                if (
                  ...
                  s.each(function (t) {
                    ...
                    i && i.addClass('hidden'),
                    e.not('.hidden').first().addClass('active'),
                    n.$menuInner.scrollTop(0);
                }
              }
            });
        },
        ...
        keydown: function (e) {
          ...
          if (
            ...
            return (
              a.options.container
                ...
                : (a.setSize(), a.$menu.parent().addClass('open'), (n = !0)),
          ...
          if (
            ...
            (i = a.options.liveSearch
              ...
              : t.index(t.find('a').filter(':focus').parent())),
              (s = a.$menuInner.data('prevIndex')),
              38 == e.keyCode
                ? ((!a.options.liveSearch && i != s) || -1 == i || i--,
                  i < 0 && (i += t.length))
                : 40 == e.keyCode &&
                  ((a.options.liveSearch || i == s) && i++, (i %= t.length)),
            ...
            (t = a.$lis.filter(r)).each(function (t) {
              ...
              l[e.keyCode]
                ...
                : h >= d.length &&
                  (T(document).data('keycount', 0), h > d.length && (h = 1)),
              t
                .eq(d[h - 1])
                .children('a')
                .focus();
          ...
          this.each(function () {
            ...
            if (c.parent().hasClass(R.wrapperClass)) {
              ...
              v.css(x),
                ...
                C(),
                'bottom' === R.start
                  ? (b.css({ top: c.outerHeight() - b.outerHeight() }),
                    w(0, !0))
                  : 'top' !== R.start &&
              ...
              (l = r),
                a >= c.outerHeight()
                  ...
                  : (b.stop(!0, !0).fadeIn('fast'),
                    R.railVisible && v.stop(!0, !0).fadeIn('fast'));
            }
            function $() {
              R.alwaysVisible ||
  ...
  (function (t, e) {
    ...
    function p(t) {
      ...
      return (
        ...
        (i =
          null !== (n = s = a) && n === n.window
            ? s
            : 9 === s.nodeType && s.defaultView),
        {
    ...
    var u = {
        ...
        show: function (t, e, i) {
          ...
          (a =
            ...
            (a =
              'touches' in t && t.touches.length
                ? ((o = t.touches[0].pageY - n.top),
                  t.touches[0].pageX - n.left)
          ...
          i && (l = 'translate(' + i.x + 'px, ' + i.y + 'px)'),
            ...
            s.setAttribute('data-x', a),
            s.setAttribute('data-y', o),
            s.setAttribute('data-scale', r),
            s.setAttribute('data-translate', l);
          var h = { top: o + 'px', left: a + 'px' };
          s.classList.add('waves-notransition'),
            s.setAttribute('style', c(h)),
            s.classList.remove('waves-notransition'),
            (h['-webkit-transform'] = r + ' ' + l),
            (h['-moz-transform'] = r + ' ' + l),
            (h['-ms-transform'] = r + ' ' + l),
            (h['-o-transform'] = r + ' ' + l),
            (h.transform = r + ' ' + l),
        ...
        input: function (t) {
          ...
          if (
            ...
            var s = window.getComputedStyle(t, null),
              n = s.color,
              o = s.backgroundColor;
            i.setAttribute('style', 'color:' + n + ';background:' + o),
      ...
      if (null !== i) {
        ...
        if ((h.registerEvent(e), 'touchstart' === e.type && u.delay)) {
          var s = !1,
            ...
            o = function (t) {
              n && (clearTimeout(n), (n = null), u.show(e, i)),
                s || ((s = !0), u.hide(t, i));
            };
          i.addEventListener(
            'touchmove',
    ...
    return (
      ...
      (e.attach = function (t, e) {
        var i, s;
        (t = d(t)),
          '[object Array]' === a.call(e) && (e = e.join(' ')),
          (e = e ? ' ' + e : '');
        for (var n = 0, o = t.length; n < o; n++)
          (s = (i = t[n]).tagName.toLowerCase()),
            -1 !== ['input', 'img'].indexOf(s) &&
              (l[s](i), (i = i.parentElement)),
    ...
    (t = function (_) {
      ...
      (t = function () {
            ...
            render: function (t, e, i) {
              ...
              return this.format.replace(this.fre, function () {
                return (
                  (n = arguments[1]),
                  (o = arguments[3]),
                  (s = l.precre.exec(n)) ? ((r = s[2]), (n = s[1])) : (r = !1),
                  (a = h[n]) === B
                    ? ''
                    : o && e && e[o]
                    ? e[o].get
        ...
        (p = function (t, e, i, s, n) {
          ...
          for (
            t = (!1 === e ? parseFloat(t).toString() : t.toFixed(e)).split(''),
              (o = (o = _.inArray('.', t)) < 0 ? t.length : o) < t.length &&
                (t[o] = n),
              a = o - i;
            0 < a;
            a -= i
        ...
        (_.fn.simpledraw = function (t, e, i, s) {
          ...
          return (
            t === B && (t = _(this).innerWidth()),
            e === B && (e = _(this).innerHeight()),
            (n = _.fn.sparkline.canvas(t, e, this, s)),
            (o = _(this).data('_jqs_mhandler')) && o.registerCanvas(n),
            n
          );
        }),
        ...
        (c = e({
          ...
          registerCanvas: function (t) {
            var e = _(t.canvas);
            (this.canvas = t),
              (this.$canvas = e).mouseenter(_.proxy(this.mouseenter, this)),
              e.mouseleave(_.proxy(this.mouseleave, this)),
              e.click(_.proxy(this.mouseclick, this));
          },
          reset: function (t) {
            (this.splist = []),
              this.tooltip && t && (this.tooltip.remove(), (this.tooltip = B));
          },
          ...
          mouseenter: function (t) {
            _($.body).unbind('mousemove.jqs'),
              _($.body).bind('mousemove.jqs', _.proxy(this.mousemove, this)),
              (this.over = !0),
          ...
          updateDisplay: function () {
            ...
            if (this.over) {
              ...
              if (a) {
                if (
                  (((s = _.Event('sparklineRegionChange')).sparklines =
                    this.splist),
                  this.$el.trigger(s),
                  this.tooltip)
                ) {
        ...
        (s = e({
          ...
          init: function (t) {
            var e,
              ...
              s = this.sizeStyle;
            (this.container = t.get('tooltipContainer') || $.body),
              ...
              (this.hidden = !0),
              _(window).unbind('resize.jqs scroll.jqs'),
              _(window).bind(
          ...
          updateWindowDims: function () {
            (this.scrollTop = _(window).scrollTop()),
              (this.scrollLeft = _(window).scrollLeft()),
              (this.scrollRight = this.scrollLeft + _(window).width()),
              this.updatePosition();
          },
          getSize: function (t) {
              ...
              ((t = function () {
                ...
                (t =
                  ...
                  r.get('disableInteraction')
                    ...
                    : ((n = new c(this, r)), _.data(this, '_jqs_mhandler', n)),
                  !r.get('composite') || _.data(this, '_jqs_vcanvas')
        ...
        (_.fn.sparkline.defaults = t()),
        (_.sparkline_display_visible = function () {
          var t,
            e,
            i,
            s = [];
          for (e = 0, i = b.length; e < i; e++)
            (t = b[e][0]),
              _(t).is(':visible') && !_(t).parents().is(':hidden')
                ? (b[e][1].call(t),
                  _.data(b[e][0], '_jqs_pending', !1),
                  s.push(e))
        ...
        (_.fn.sparkline.options = e({
          init: function (t, e) {
            ...
            (this.userOptions = e = e || {}),
              (this.tag = t),
              (this.tagValCache = {}),
              (n = (s = _.fn.sparkline.defaults).common),
              ...
              (i =
                (o = this.getTagSetting('type')) === x
                  ? s[e.type || n.type]
                  : s[o]),
              (this.mergedOptions = _.extend({}, n, i, e));
          },
        ...
        (_.fn.sparkline.line = L =
          e(_.fn.sparkline._base, {
            type: 'line',
            init: function (t, e, i, s, n) {
            ...
            scanValues: function () {
              ...
              for (t = 0; t < a; t++)
                (e = o[t]),
                  (i = 'string' == typeof o[t]),
                  (s = 'object' == typeof o[t] && o[t] instanceof Array),
                  (n = i && o[t].split(':')),
                  i && 2 === n.length
                    ? (r.push(Number(n[0])),
                      l.push(Number(n[1])),
              ...
              this.options.get('xvalues') && (r = this.options.get('xvalues')),
                (this.maxy = this.maxyorg = N.max.apply(N, h)),
                (this.miny = this.minyorg = N.min.apply(N, h)),
                (this.maxx = N.max.apply(N, r)),
                (this.minx = N.min.apply(N, r)),
                (this.xvalues = r),
                (this.yvalues = l),
                (this.yminmax = h);
            },
            ...
            render: function () {
              ...
              if (
                ...
                for (
                  s = n = 0,
                    ...
                    $.get('normalRangeMin') === B ||
                      $.get('drawNormalOnTop') ||
                      this.drawNormalRange(n, s, T, R, e),
                    r = [(a = [])],
                    c = u = null,
                    g = C.length,
                    S = 0;
                ...
                if (E && $.get('valueSpots'))
                  for (
                    (b = $.get('valueSpots')).get === B && (b = new q(b)),
                      S = 0;
                    S < g;
                    S++
                  )
        ...
        (_.fn.sparkline.bar = D =
          e(_.fn.sparkline._base, n, {
            type: 'bar',
            init: function (t, e, i, s, n) {
              var o,
                a,
              ...
              (this.stacked = x),
                ...
                (this.barWidth = R),
                (this.barSpacing = T),
                (this.totalBarWidth = R + T),
                (this.width = s = e.length * R + (e.length - 1) * T),
                this.initTarget(),
                H && ((v = I === B ? -1 / 0 : I), (b = E === B ? 1 / 0 : E)),
                (h = []),
                (l = x ? [] : h);
              var A = [],
                P = [];
              for (d = 0, p = e.length; d < p; d++)
                if (x)
                  ...
                  ($ = H ? j(e[d], v, b) : e[d]),
                    null !== ($ = e[d] = W($)) && h.push($);
              (this.max = m = N.max.apply(N, h)),
                (this.min = f = N.min.apply(N, h)),
                (this.stackMax = M = x ? N.max.apply(N, A) : m),
                (this.stackMin = L = x ? N.min.apply(N, h) : f),
                i.get('chartRangeMin') !== B &&
                  (i.get('chartRangeClip') || i.get('chartRangeMin') < f) &&
                  (f = i.get('chartRangeMin')),
                i.get('chartRangeMax') !== B &&
                  (i.get('chartRangeClip') || i.get('chartRangeMax') > m) &&
                  (m = i.get('chartRangeMax')),
                (this.zeroAxis = u = i.get('zeroAxis', !0)),
                (g = f <= 0 && 0 <= m && u ? 0 : 0 == u ? f : 0 < f ? f : m),
                (this.xaxisOffset = g),
                (c = x ? N.max.apply(N, l) + N.max.apply(N, P) : m - f),
                (this.canvasHeightEf =
                  u && f < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1),
                f < g
                  ? (k =
                      (((x && 0 <= m ? M : m) - g) / c) * this.canvasHeight) !==
                      N.ceil(k) && ((this.canvasHeightEf -= 2), (k = N.ceil(k)))
                  : (k = this.canvasHeight),
                (this.yoffset = k),
                _.isArray(i.get('colorMap'))
            ...
            calcColor: function (t, e, i) {
              ...
              return (
                (s = this.stacked
                  ...
                  ? r.get('negBarColor')
                  : r.get('barColor')),
                0 === e && r.get('zeroColor') !== B && (s = r.get('zeroColor')),
                a && (n = a.get(e)) ? (s = n) : o && o.length > i && (s = o[i]),
                _.isArray(s) ? s[t % s.length] : s
              );
            },
            renderRegion: function (t, e) {
              ...
              for (a = w, r = 0; r < l; r++) {
                ...
                (s = 0 < m ? N.floor(y * (N.abs(h - g) / m)) + 1 : 1),
                  h < g || (h === g && 0 === w)
                    ? ((i = a), (a += s))
                    : ((i = w - s), (w -= s)),
                  (n = this.calcColor(r, h, t)),
                  e && (n = this.calcHighlightColor(n, u)),
                  f.push(b.drawRect(x, i, this.barWidth - 1, s - 1, n, n));
              }
              return 1 === f.length ? f[0] : f;
            },
          })),
        (_.fn.sparkline.tristate = r =
          e(_.fn.sparkline._base, n, {
            type: 'tristate',
            init: function (t, e, i, s, n) {
              var o = parseInt(i.get('barWidth'), 10),
                a = parseInt(i.get('barSpacing'), 10);
              r._super.init.call(this, t, e, i, s, n),
                (this.regionShapes = {}),
                (this.barWidth = o),
                (this.barSpacing = a),
                (this.totalBarWidth = o + a),
                (this.values = _.map(e, Number)),
                (this.width = s = e.length * o + (e.length - 1) * a),
                _.isArray(i.get('colorMap'))
                  ? ((this.colorMapByIndex = i.get('colorMap')),
                    (this.colorMapByValue = null))
                  : ((this.colorMapByIndex = null),
            ...
            renderRegion: function (t, e) {
              ...
              if (
                ...
                return (
                  e && (r = this.calcHighlightColor(r, h)),
                  d.drawRect(o, a, this.barWidth - 1, s - 1, r, r)
                );
            },
          })),
        (_.fn.sparkline.discrete = a =
          e(_.fn.sparkline._base, n, {
            type: 'discrete',
            init: function (t, e, i, s, n) {
              a._super.init.call(this, t, e, i, s, n),
                ...
                (this.min = N.min.apply(N, e)),
                (this.max = N.max.apply(N, e)),
                (this.range = this.max - this.min),
                (this.width = s =
                  'auto' === i.get('width') ? 2 * e.length : this.width),
                (this.interval = N.floor(s / e.length)),
              ...
              return (
                ...
                (n =
                  r.get('thresholdColor') && s < r.get('thresholdValue')
                    ...
                    : r.get('lineColor')),
                e && (n = this.calcHighlightColor(n, r)),
                c.drawLine(o, i, o, i + g, n)
              );
            },
          })),
        (_.fn.sparkline.bullet = l =
          e(_.fn.sparkline._base, {
            type: 'bullet',
            init: function (t, e, i, s, n) {
              var o, a, r;
              l._super.init.call(this, t, e, i, s, n),
                ...
                (o = N.min.apply(N, e)),
                (a = N.max.apply(N, e)),
                (o = i.get('base') === B ? (o < 0 ? o : 0) : i.get('base')),
                (this.min = o),
                (this.max = a),
                (this.range = a - o),
                (this.shapes = {}),
            ...
            renderTarget: function (t) {
              ...
              return (
                t && (o = this.calcHighlightColor(o, this.options)),
                this.target.drawRect(
                  i,
                  s,
            ...
            renderSlice: function (t, e) {
              ...
              for (o = u.length, n = 0; n < o; n++) {
                if (((s = i = f), 0 < g && (s = f + c * (u[n] / g)), t === n))
                  return (
                    (a = l.get('sliceColors')[n % l.get('sliceColors').length]),
                    e && (a = this.calcHighlightColor(a, l)),
                    r.drawPieSlice(h, h, h - d, i, s, B, a)
                  );
                f = s;
              }
            },
            ...
            render: function () {
              ...
              if (w._super.render.call(this)) {
                if (g.get('raw'))
                  ...
                  for (t = a = B, l = 0; l < u; l++)
                    t === B && c[l] > s - i * g.get('outlierIQR') && (t = c[l]),
                      c[l] < o + i * g.get('outlierIQR') && (a = c[l]);
                  (e = c[0]), (r = c[u - 1]);
                } else (t = c[0]), (a = c[u - 1]);
                (this.quartiles = [s, n, o]),
                  (this.lwhisker = t),
                  (this.rwhisker = a),
                  (this.loutlier = e),
                  (this.routlier = r),
        ...
        (g = e({
          ...
          _calculatePixelDims: function (t, e, i) {
            ...
            (s = this._pxregex.exec(e)),
              (this.pixelHeight = s ? s[1] : _(i).height()),
              (s = this._pxregex.exec(t)),
              (this.pixelWidth = s ? s[1] : _(i).width());
          },
        ...
        (m = e(g, {
          init: function (t, e, i) {
            var s;
            m._super.init.call(this, t, e, i),
              i[0] && (i = i[0]),
              _.data(i, '_jqs_vcanvas', this),
              (this.canvas = $.createElement('span')),
              _(this.canvas).css({
                display: 'inline-block',
                position: 'relative',
                overflow: 'hidden',
              ...
              (this.group = _(this.canvas).children()[0]),
              (this.rendered = !1),
              (this.prerender = '');
          },
          _drawShape: function (t, e, i, s, n) {
  ...
  (function (t) {
    ...
    var a = function (t, e) {
      (this.$element = o(t)),
        (this.options = o.extend({}, a.DEFAULTS, this.dataOptions(), e)),
        this.init();
    };
    (a.DEFAULTS = {
      from: 0,
      ...
      (o.fn.countTo = function (n) {
        return this.each(function () {
          ...
          (!e || 'object' == typeof n) &&
            (e && e.stop(), t.data('countTo', (e = new a(this, i)))),
            e[s].call(e);
        });
      });
  });
