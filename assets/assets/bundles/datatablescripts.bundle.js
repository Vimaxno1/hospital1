!(function (n) {
  ...
  function x(t, e, n) {
    ...
    (e._bAttrSrc =
      ...
      t.oFeatures.bSort || ((e.bSortable = !1), r.addClass(a.sSortableNone)),
        ...
        (n !== j && n !== u) ||
          ...
          o && o._bAttrSrc
            ? (p(o.mData._)(a, i),
              ...
              d(o.mData.filter, t))
            : f
            ? (o._setter || (o._setter = p(o.mData)), o._setter(a, i))
            : (a[u] = i)),
          u++;
      };
    if (s)
  ...
  function g(t, e, n, a) {
    ...
    if (null === u.nTr) {
      for (
        ...
        (i = t.aoColumns[l]),
          ((o = n ? a[l] : S.createElement(i.sCellType))._DT_CellIndex = {
            row: e,
            column: l,
          }),
          f.push(o),
          ...
          i.fnCreatedCell &&
            i.fnCreatedCell.call(t.oInstance, o, R(t, e, l), c, e, l);
  ...
  function M(t) {
    ...
    if (-1 !== P.inArray(!1, e)) dt(t, !1);
      ...
      (t.bDrawing = !0),
        i !== j &&
          -1 !== i &&
          ((t._iDisplayStart = l ? i : i >= t.fnRecordsDisplay() ? 0 : i),
    ...
    for (r = 0, l = d.length; r < l; r++)
      for (a = (n = d[r]).firstChild; a; ) {
        if (
          ...
          for (
            u =
              (u = 1 * a.getAttribute('colspan')) && 0 !== u && 1 !== u ? u : 1,
              c =
  ...
  function t(t) {
    ...
    return (
      ...
      null === (o = qt.ext.legacy.ajax) ? (t.sAjaxSource ? c : h) : o ? c : h
    );
  }
  function J(t, e) {
    var n = q(t, e),
  ...
  function G(n) {
    var t = n.oClasses,
      ...
      s =
        ...
        (i =
          null !== n.searchDelay ? n.searchDelay : 'ssp' === Wt(n) ? 400 : 0),
        P('input', t)
          .val(r.sSearch)
          .attr('placeholder', a.sSearchPlaceholder)
          .on('keyup.DT search.DT input.DT paste.DT cut.DT', i ? be(o, i) : o)
  ...
  function ut(t) {
    var e = t.sPaginationType,
      ...
      u =
        ((e = P('<div/>').addClass(t.oClasses.sPaging + e)[0]), t.aanFeatures);
    return (
      l || i.fnInit(t, e, s),
      u.p ||
    ...
    (e = p.scrollHeight > p.clientHeight),
      n.scrollBarVis !== e && n.scrollBarVis !== j
        ...
        : ((n.scrollBarVis = e),
          ...
          (d[(s = 'padding' + (w.bScrollbarLeft ? 'Left' : 'Right'))] = l
            ? u + 'px'
            : '0px'),
          T &&
        ...
        ? o.sort(function (t, e) {
            ...
            for (r = 0; r < i; r++)
              if (
                0 !==
                (n =
                  (n = l[(o = u[r]).col]) < (a = s[o.col]) ? -1 : a < n ? 1 : 0)
              )
        ...
        : o.sort(function (t, e) {
            ...
            for (r = 0; r < i; r++)
              if (
                ...
                (a = s[o.col]),
                0 !==
                  (n = (o = f[o.type + '-' + o.dir] || f['string-' + o.dir])(
                    n,
                    a
                  )))
              )
      ...
      n && t.oFeatures.bSortMulti
        ? -1 !== (n = P.inArray(e, re(r, '0')))
          ? (null === (e = i(r[n], !0)) && 1 === r.length && (e = 0),
            null === e ? r.splice(n, 1) : ((r[n][1] = o[e]), (r[n]._idx = e)))
          : (r.push([e, o[0], 0]), (r[r.length - 1]._idx = 0))
        : r.length && r[0][0] == e
        ? ((e = i(r[0])), (r.length = 1), (r[0][1] = o[e]), (r[0]._idx = e))
  ...
  function xt(t) {
    ...
    if (i.bSort && i.bSortClasses) {
      for (i = 0, e = a.length; i < e; i++)
        (n = a[i].src),
          P(re(t.aoData, 'anCells', n)).removeClass(r + (i < 2 ? i + 1 : 3));
      for (i = 0, e = o.length; i < e; i++)
        (n = o[i].src),
          P(re(t.aoData, 'anCells', n)).addClass(r + (i < 2 ? i + 1 : 3));
    }
    t.aLastSort = o;
  }
  function It(t, e) {
    ...
    P.each(
      ...
      function (t, e) {
        (Ut.type.order[t + n + '-pre'] = e),
          t.match(/^html\-/) && (Ut.type.search[t + n] = Ut.type.search.html);
      }
    );
  }
  function e(e) {
  ...
  var Ut,
        ...
        this.each(function () {
          ...
          if ('table' != this.nodeName.toLowerCase())
            ...
            (c.nTable = this),
              ...
              Nt(c, 'aoStateSaveParams', a.fnStateSaveParams, 'user'),
              Nt(c, 'aoStateLoadParams', a.fnStateLoadParams, 'user'),
              Nt(c, 'aoStateLoaded', a.fnStateLoaded, 'user'),
              Nt(c, 'aoRowCallback', a.fnRowCallback, 'user'),
              Nt(c, 'aoRowCreatedCallback', a.fnCreatedRow, 'user'),
              Nt(c, 'aoHeaderCallback', a.fnHeaderCallback, 'user'),
              Nt(c, 'aoFooterCallback', a.fnFooterCallback, 'user'),
              Nt(c, 'aoInitComplete', a.fnInitComplete, 'user'),
              Nt(c, 'aoPreDrawCallback', a.fnPreDrawCallback, 'user'),
              (c.rowIdFn = k(a.rowId)),
              w(c);
            var f = c.oClasses;
            ...
            if (
              ...
              (t = []),
              0 !== (l = this.getElementsByTagName('thead')).length &&
            ...
            t = function () {
              ...
              if (
                (0 === e.length && (e = P('<thead/>').appendTo(i)),
                (c.nTHead = e[0]),
    ...
    ae = function (t, e, n) {
      return (
        !!Kt(t) ||
        ((Kt(t) || 'string' == typeof t) && !!ne(t.replace(zt, ''), e, n)) ||
        null
      );
    },
    re = function (t, e, n) {
  ...
  var De = function (t, e, n, a, r) {
      ...
      for (
        l = typeof e,
          (e && 'string' !== l && 'function' !== l && e.length !== j) ||
            (e = [e]),
          l = 0,
          s = e.length;
        l < s;
      ...
      function (a) {
        ...
        return De(
          ...
          function (n) {
            ...
            if ((r || (r = Te(a, o)), null !== t && -1 !== P.inArray(t, r)))
              return [t];
    ...
    Xt('row().data()', function (t) {
      ...
      return t === j
        ? e.length && this.length
          ...
          : j
        : ((e[0].aoData[this[0]]._aData = t), r(e[0], this[0], 'data'), this);
    }),
            ...
            m = function (t, e) {
              ...
              for (n = 0, a = e.length; n < a; n++)
                if (((o = e[n]), P.isArray(o)))
                  (r = P('<' + (o.DT_el || 'div') + '/>').appendTo(t)), m(r, o);
                else {
                  switch (((f = null), (d = ''), o)) {
                    case 'ellipsis':
