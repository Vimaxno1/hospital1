      ...
      (r = [i(2)]),
        void 0 ===
          (n = function (z) {
            function I(t) {
              if (I.is(t, 'function'))
                return r ? t() : z.on('raphael.DOMload', t);
              if (I.is(t, T))
                return I._engine.create[b](
                  I,
                  t.splice(0, 3 + I.is(t[0], Y))
                ).add(t);
            ...
            function B(t, e, i, r, n, s, o, a) {
              if (
                ...
                if (h) {
                  var l =
                      ((t * r - e * i) * (n - o) - (t - i) * (n * a - s * o)) /
                      h,
                    u =
                      ((t * r - e * i) * (s - a) - (e - r) * (n * a - s * o)) /
                      h,
                    c = +l.toFixed(2),
                    p = +u.toFixed(2);
                  if (
            ...
            function k(t, e, i) {
              ...
              for (
                ...
                l.push({ x: d.x, y: d.y, t: f / a });
              }
              for (f = 0; f < h + 1; f++)
                (d = I.findDotsAtSegment.apply(I, e.concat(f / h))),
                  u.push({ x: d.x, y: d.y, t: f / h });
              for (f = 0; f < a; f++)
                for (var g = 0; g < h; g++) {
                  var x = l[f],
                    v = l[f + 1],
                  ...
                  if (_) {
                    ...
                    0 <= k &&
                      ...
                      (i
                        ? p++
                        : p.push({ x: _.x, y: _.y, t1: L(k, 1), t2: L(C, 1) }));
                  }
                }
              return p;
            }
            function n(t, e, i) {
              ...
              for (
                ...
                if ('M' == x[0]) (r = a = x[1]), (n = h = x[2]);
                  ...
                  n =
                    'C' == x[0]
                      ? ((r = (c = [r, n].concat(x.slice(1)))[6]), c[7])
                      : ((c = [r, n, r, n, a, h, a, h]), (r = a), h);
                  for (var v = 0, y = e.length; v < y; v++) {
                    ...
                    if ('M' == m[0]) (s = l = m[1]), (o = u = m[2]);
                      ...
                      o =
                        'C' == m[0]
                          ? ((s = (p = [s, o].concat(m.slice(1)))[6]), p[7])
                          : ((p = [s, o, s, o, l, u, l, u]), (s = l), u);
                      var b = k(c, p, i);
                      if (i) f += b;
                      else {
            ...
            function _(t, e, i, r, n, s) {
              ...
              if (r)
                for (v = 0, y = re.length; v < y; v++) {
                  ...
                  if (x.el.id == e.id && x.anim == t) {
                    x.percent != i ? (re.splice(v, 1), (h = 1)) : (a = x),
                      e.attr(x.totalOrigin);
                    break;
                  }
                }
              else r = +d;
              ...
              if (o) {
                if (a) (a.initstatus = r), (a.start = new Date() - a.ms * r);
                  ...
                  for (var m in o)
                    if (o[N](m) && (K[N](m) || e.paper.customAttributes[N](m)))
                      switch (
                        ((f[m] = e.attr(m)),
                        null == f[m] && (f[m] = J[m]),
                        (d[m] = o[m]),
                        ...
                        case 'path':
                          var w = Pt(f[m], d[m]),
                            _ = w[1];
                          for (
                            f[m] = w[0], g[m] = [], v = 0, y = f[m].length;
                            v < y;
                            v++
                          ) {
                            g[m][v] = [0];
                            for (var k = 1, C = f[m][v].length; k < C; k++)
                              g[m][v][k] = (_[v][k] - f[m][v][k]) / p;
                          }
                          break;
                        case 'transform':
                          var S = e._,
                        ...
                        default:
                          for (
                            F = [][j](o[m]),
                              T = [][j](f[m]),
                              g[m] = [],
                              v = e.paper.customAttributes[m].length;
                            v--;
                  ...
                  if (
                    ...
                    r &&
                      ...
                      !h &&
                      ((x.stop = !0),
                      (x.start = new Date() - p * r),
                      1 == re.length))
                  )
                    return se();
                  h && (x.start = new Date() - x.ms * r),
                    1 == re.length && ne(se);
                }
            ...
            var r,
              ...
              pt = (I.mapPath = function (t, e) {
                ...
                for (n = 0, o = (t = Pt(t)).length; n < o; n++)
                  for (s = 1, a = (h = t[n]).length; s < a; s += 2)
                    (i = e.x(h[s], h[s + 1])),
                      (r = e.y(h[s], h[s + 1])),
                      (h[s] = i),
                      (h[s + 1] = r);
            ...
            if (
              ...
              var ft,
                dt = d.doc.createElement('div');
              if (
                ((dt.innerHTML = '<v:shape adj="1"/>'),
                ((ft = dt.firstChild).style.behavior = 'url(#default#VML)'),
            ...
            (I.svg = !(I.vml = 'VML' == I.type)),
              (I._Paper = l),
              (I.fn = e = l.prototype = I.prototype),
              (I._id = 0),
              (I._oid = 0),
              (I.is = function (t, e) {
                return 'finite' == (e = w.call(e))
                  ...
                  : ('null' == e && null === t) ||
                    ...
                    x.call(t).slice(8, -1).toLowerCase() == e;
              }),
            ...
            I.setWindow = function (t) {
              z('raphael.setWindow', I, d.win, t),
                (d.win = t),
                (d.doc = d.win.document),
                I._engine.initWin && I._engine.initWin(d.win);
            };
            var vt = function (t) {
                if (I.vml) {
                  var i,
            ...
            (I.color = function (t) {
              var e;
              return (
                I.is(t, 'object') && 'h' in t && 's' in t && 'b' in t
                  ? ((e = I.hsb2rgb(t)),
                    (t.r = e.r),
                    (t.g = e.g),
                    (t.b = e.b),
                    (t.hex = e.hex))
                  : I.is(t, 'object') && 'h' in t && 's' in t && 'l' in t
                  ? ((e = I.hsl2rgb(t)),
                    (t.r = e.r),
                    (t.g = e.g),
                    (t.b = e.b),
                    (t.hex = e.hex))
                  : (I.is(t, 'string') && (t = I.getRGB(t)),
                    I.is(t, 'object') && 'r' in t && 'g' in t && 'b' in t
                      ? ((e = I.rgb2hsl(t)),
                        (t.h = e.h),
                        (t.s = e.s),
                        (t.l = e.l),
            ...
            (I.getRGB = O(function (t) {
              ...
              !et[N](t.toLowerCase().substring(0, 2)) &&
                '#' != t.charAt() &&
                (t = vt(t));
              var e,
                i,
              ...
              return a
                ? (a[2] &&
                    ((r = Z(a[2].substring(5), 16)),
                    (i = Z(a[2].substring(3, 5), 16)),
                    (e = Z(a[2].substring(1, 3), 16))),
                  a[3] &&
                    ((r = Z((s = a[3].charAt(3)) + s, 16)),
                    (i = Z((s = a[3].charAt(2)) + s, 16)),
                    (e = Z((s = a[3].charAt(1)) + s, 16))),
                  a[4] &&
                    ((o = a[4][X](tt)),
                    (e = $(o[0])),
                    '%' == o[0].slice(-1) && (e *= 2.55),
                    ...
                    (r = $(o[2])),
                    '%' == o[2].slice(-1) && (r *= 2.55),
                    'rgba' == a[1].toLowerCase().slice(0, 4) && (n = $(o[3])),
                  ...
                  a[5]
                    ? ((o = a[5][X](tt)),
                      ...
                      ('deg' == o[0].slice(-3) || '°' == o[0].slice(-1)) &&
                        (e /= 360),
                      'hsba' == a[1].toLowerCase().slice(0, 4) && (n = $(o[3])),
                      o[3] && '%' == o[3].slice(-1) && (n /= 100),
                      I.hsb2rgb(e, i, r, n))
                    : a[6]
                    ? ((o = a[6][X](tt)),
                      ...
                      ('deg' == o[0].slice(-3) || '°' == o[0].slice(-1)) &&
                        (e /= 360),
                      'hsla' == a[1].toLowerCase().slice(0, 4) && (n = $(o[3])),
                      o[3] && '%' == o[3].slice(-1) && (n /= 100),
                      I.hsl2rgb(e, i, r, n))
                    : (((a = { r: e, g: i, b: r, toString: h }).hex =
                        '#' +
                        (16777216 | r | (i << 8) | (e << 16))
                          .toString(16)
                          .slice(1)),
                      I.is(n, 'finite') && (a.opacity = n),
                      a))
                : { r: -1, g: -1, b: -1, hex: 'none', error: 1, toString: h };
            }, I)),
              (I.hsb = O(function (t, e, i) {
              ...
              (I.parsePathString = function (t) {
                ...
                var s = {
                  ...
                  o = [];
                return (
                  I.is(t, T) && I.is(t[0], T) && (o = St(t)),
                  o.length ||
                    G(t).replace(rt, function (t, e, i) {
                      var r = [],
                        n = e.toLowerCase();
                      if (
                        ...
                        for (
                          ;
                          r.length >= s[n] &&
                          (o.push([e][j](r.splice(0, s[n]))), s[n]);

                        );
                    }),
                  (o.toString = I._path2string),
                  (e.arr = St(o)),
                  o
                );
              }),
              (I.parseTransformString = O(function (t) {
                ...
                var n = [];
                return (
                  I.is(t, T) && I.is(t[0], T) && (n = St(t)),
                  n.length ||
                    G(t).replace(nt, function (t, e, i) {
                      var r = [];
                      w.call(e);
                      i.replace(st, function (t, e) {
                        e && r.push(+e);
            ...
            var Ct = (I.pathBBox = function (t) {
                ...
                for (
                  ...
                  if ('M' == (i = t[a])[0])
                    (r = i[1]), (n = i[2]), s.push(r), o.push(n);
                  else {
                    var l = Et(r, n, i[1], i[2], i[3], i[4], i[5], i[6]);
                    (s = s[j](l.min.x, l.max.x)),
                      (o = o[j](l.min.y, l.max.y)),
                      (r = i[5]),
                      (n = i[6]);
                  }
                var u = L[b](0, s),
              ...
              Bt = (I._pathToRelative = function (t) {
                ...
                (I.is(t, T) && I.is(t && t[0], T)) ||
                  (t = I.parsePathString(t));
                var i = [],
                  r = 0,
                  n = 0,
                  s = 0,
              ...
              Mt = (I._pathToAbsolute = function (t) {
                ...
                for (
                  ...
                  if ((i.push((h = [])), (l = t[c])[0] != Q.call(l[0])))
                    switch (((h[0] = Q.call(l[0])), h[0])) {
                      case 'A':
                        (h[1] = l[1]),
                          (h[2] = l[2]),
                          (h[3] = l[3]),
                      ...
                      case 'R':
                        for (
                          var f = [r, n][j](l.slice(1)), d = 2, g = f.length;
                          d < g;
                          d++
                        )
                          (f[d] = +f[d] + r), (f[++d] = +f[d] + n);
                    ...
                    (f = [r, n][j](l.slice(1))),
                      ...
                      (i = i[j](y(f, u))),
                      (h = ['R'][j](l.slice(-2)));
                  else for (var x = 0, v = l.length; x < v; x++) h[x] = l[x];
                  switch (h[0]) {
                    case 'Z':
                      (r = s), (n = o);
                      break;
              ...
              Tt = function (t, e, i, r, n, s, o, a, h, l) {
                ...
                if (l) (k = l[0]), (C = l[1]), (w = l[2]), (_ = l[3]);
                  ...
                  (k = t < w ? U - k : k) < 0 && (k = 2 * U + k),
                    (C = a < w ? U - C : C) < 0 && (C = 2 * U + C),
                    o && C < k && (k -= 2 * U),
                    !o && k < C && (C -= 2 * U);
                }
                var S = C - k;
                if (V(S) > c) {
                  ...
                  (C = k + c * (o && k < C ? 1 : -1)),
                    (a = w + i * q.cos(C)),
                    (h = _ + r * q.sin(C)),
                    (f = Tt(a, h, i, r, n, 0, o, M, L, [C, B, w, _]));
                }
                S = C - k;
                var F = q.cos(k),
                  T = q.sin(k),
                  ...
                  H = [a + z * E, h - I * A],
                  N = [a, h];
                if (((R[0] = 2 * D[0] - R[0]), (R[1] = 2 * D[1] - R[1]), l))
                  return [R, H, N][j](f);
                for (
                  var G = [],
                    Y = 0,
                    W = (f = [R, H, N][j](f).join()[X](',')).length;
                  Y < W;
                  Y++
                )
                  G[Y] =
                    Y % 2 ? d(f[Y - 1], f[Y], p).y : d(f[Y], f[Y + 1], p).x;
                return G;
              },
              ...
              Et = O(function (t, e, i, r, n, s, o, a) {
                ...
                return (
                  ...
                  0 < p &&
                    p < 1 &&
                    ((h = At(t, e, i, r, n, s, o, a, p)),
                    g.push(h.x),
                    d.push(h.y)),
                  0 < f &&
                    f < 1 &&
                    ((h = At(t, e, i, r, n, s, o, a, f)),
                    g.push(h.x),
                    d.push(h.y)),
                  (l = s - 2 * r + e - (a - 2 * s + r)),
                  (c = e - r),
                  ...
                  0 < f &&
                    ...
                    d.push(h.y)),
                  {
                    min: { x: L[b](0, g), y: L[b](0, d) },
                    max: { x: M[b](0, g), y: M[b](0, d) },
                  }
                );
              }),
              Pt = (I._path2curve = O(
                      ...
                      h = function (t, e) {
                        if (7 < t[e].length) {
                          ...
                          for (var i = t[e]; i.length; )
                            (u[e] = 'A'),
                              o && (c[e] = 'A'),
                              t.splice(e++, 0, ['C'][j](i.splice(0, 6)));
                          t.splice(e, 1),
                            (g = M(s.length, (o && o.length) || 0));
                        }
                      },
              ...
              zt =
                ((I._parseDots = O(function (t) {
                  for (var e = [], i = 0, r = t.length; i < r; i++) {
                    var n = {},
                      s = t[i].match(/^([^:]*):?([\d\.]*)/);
                    if (((n.color = I.getRGB(s[1])), n.color.error))
                      return null;
                  ...
                  for (i = 1, r = e.length - 1; i < r; i++)
                    if (!e[i].offset) {
                      for (
                        var o = $(e[i - 1].offset || 0), a = 0, h = i + 1;
                        h < r;
                        h++
                      )
                        if (e[h].offset) {
                          ...
                          : 5 == y &&
                            (b
                              ? ((d = w.x(v[3], v[4])),
                                (g = w.y(v[3], v[4])),
                                l.scale(v[1], v[2], d, g))
                              : l.scale(v[1], v[2], v[3], v[4]),
                            (o *= v[1]),
                            (a *= v[2]))
                        : 'm' == m &&
                          7 == y &&
                          l.add(v[1], v[2], v[3], v[4], v[5], v[6]),
                        (h.dirtyT = 1),
                        (t.matrix = l);
                    }
                  (t.matrix = l),
              ...
              Ht = (I._equaliseTransform = function (t, e) {
                ...
                for (
                  ...
                  if (
                    ...
                    return;
                  for (
                    a[l] = [], h[l] = [], i = 0, r = M(n.length, s.length);
                    i < r;
                    i++
                  )
            ...
            (I._getContainer = function (t, e, i, r) {
              ...
              return null !=
                (n =
                  null != r || I.is(t, 'object') ? t : d.doc.getElementById(t))
                ? n.tagName
                  ? null == e
                    ? {
                        container: n,
              ...
              (function (t) {
                ...
                (t.add = function (t, e, i, r, n, s) {
                  ...
                  (t.split = function () {
                    ...
                    return (
                      r < 0
                        ? ((t.rotate = I.deg(q.acos(r))),
                          i < 0 && (t.rotate = 360 - t.rotate))
                        : (t.rotate = I.deg(q.asin(i))),
                      (t.isSimple = !(
                        +t.shear.toFixed(9) ||
                  ...
                  ? function (s, t, o, a) {
                      ...
                      return function () {
                        return (
                          ...
                          g && p[t] && s.removeEventListener(p[t], i, !1),
                          !0
                        );
                      };
                    }
                  ...
                  ? function (t, e, s, o) {
                      var i = function (t) {
                        ...
                        var e =
                          ...
                          n = t.clientY + e;
                        return (
                          (t.preventDefault = t.preventDefault || Nt),
                          (t.stopPropagation = t.stopPropagation || Yt),
                          s.call(o, t, r, n)
                        );
                      };
                      return (
                ...
                qt = function (t) {
                  for (
                    ...
                    d.win.opera && p.removeChild(u),
                      ...
                      l && z('raphael.drag.over.' + e.el.id, e.el, l),
                      (i += s),
                      (r += n),
                      z(
            ...
            (Ut.data = function (t, e) {
              ...
              if (1 != arguments.length)
                return (
                  (i[t] = e), z('raphael.data.set.' + this.id, this, e, t), this
                );
              if (I.is(t, 'object')) {
              ...
              (Ut.removeData = function (t) {
                return (
                  null == t
                    ? (ot[this.id] = {})
                    : ot[this.id] && delete ot[this.id][t],
                  this
                );
              }),
              (Ut.getData = function () {
            ...
            (Ut.drag = function (a, h, l, u, c, p) {
              function t(t) {
                ...
                (this._drag.x = e + n),
                  (this._drag.y = i + r),
                  !Xt.length && I.mousemove(qt).mouseup(Vt),
                  Xt.push({
                    el: this,
                    move_scope: u,
                    start_scope: c,
                  ...
                  h && z.on('raphael.drag.start.' + this.id, h),
                  a && z.on('raphael.drag.move.' + this.id, a),
                  l && z.on('raphael.drag.end.' + this.id, l),
                  z(
              ...
              (Ut.onDragOver = function (t) {
                t
                  ? z.on('raphael.drag.over.' + this.id, t)
                  : z.unbind('raphael.drag.over.' + this.id);
              }),
              (Ut.undrag = function () {
                for (var t = Zt.length; t--; )
                  Zt[t].el == this &&
                    (this.unmousedown(Zt[t].start),
                    Zt.splice(t, 1),
                    z.unbind('raphael.drag.*.' + this.id));
            ...
            (e.getElementByPoint = function (t, e) {
              ...
              if (d.win.opera && 'svg' == u.tagName) {
                var c =
                    ...
                    (h = o.clientLeft || s.clientLeft || 0),
                    {
                      y:
                        r.top +
                        (d.win.pageYOffset || o.scrollTop || s.scrollTop) -
                        a,
                      x:
                        r.left +
                        (d.win.pageXOffset || o.scrollLeft || s.scrollLeft) -
                        h,
                    }),
                  p = l.createSVGRect();
              ...
              if (!u) return null;
              for (; u.parentNode && u != l.parentNode && !u.raphael; )
                u = u.parentNode;
              return (
                u == this.canvas.parentNode && (u = l),
                u && u.raphael ? this.getById(u.raphaelid) : null
              );
            }),
              ...
              (Ut.isPointInside = function (t, e) {
                ...
                return (
                  this.attr('transform') &&
                    ...
                    (i = I.transformPath(i, this.attr('transform'))),
                  I.isPointInsidePath(i, t, e)
                );
              }),
                ...
                return t
                  ...
                  : ((e.dirty || e.dirtyT || !e.bbox) &&
                      ((!e.dirty && this.realPath) ||
                        ((e.bboxwt = 0), (this.realPath = ct[this.type](this))),
                      (e.bbox = Ct(pt(this.realPath, this.matrix))),
                      (e.bbox.toString = i),
                      (e.dirty = e.dirtyT = 0)),
                    e.bbox);
              }),
                ...
                return function (t, e, i) {
                  for (
                    ...
                    if ('M' == (s = t[c])[0]) (r = +s[1]), (n = +s[2]);
                      ...
                      if (
                        e <
                        u + (o = Qt(r, n, s[1], s[2], s[3], s[4], s[5], s[6]))
                      ) {
                        if (d && !l.start) {
                          if (
                            ((h += [
            ...
            var ie = (I.easing_formulas = {
              ...
              elastic: function (t) {
                return t == !!t
                  ? t
                  : F(2, -10 * t) * q.sin((2 * U * (t - 0.075)) / 0.3) + 1;
              },
              bounce: function (t) {
                var e = 7.5625,
                  i = 2.75;
                    ...
                    if (
                      (i.initstatus
                        ? ((s =
                          ...
                          delete i.initstatus,
                          i.stop && re.splice(e--, 1))
                        : (i.status =
                            (i.prev + (i.percent - i.prev) * (s / o)) /
                            i.anim.top),
                      !(s < 0))
                    )
                      if (s < o) {
                            ...
                            switch (K[g]) {
                              ...
                              case 'colour':
                                r =
                                  'rgb(' +
                                  [
                                    oe(P(h[g].r + d * o * l[g].r)),
                                    oe(P(h[g].g + d * o * l[g].g)),
                                    oe(P(h[g].b + d * o * l[g].b)),
                                  ].join(',') +
                                  ')';
                                break;
                              case 'path':
                                ...
                                for (var x = 0, v = h[g].length; x < v; x++) {
                                  r[x] = [h[g][x][0]];
                                  for (
                                    var y = 1, m = h[g][x].length;
                                    y < m;
                                    y++
                                  )
                                    r[x][y] = +h[g][x][y] + d * o * l[g][x][y];
                                  r[x] = r[x].join(C);
                                }
                                r = r.join(C);
                                break;
                              ...
                              default:
                                ...
                                for (
                                  r = [],
                                    x = c.paper.customAttributes[g].length;
                                  x--;
                        ...
                        if (
                          ((function (t, e, i) {
                            setTimeout(function () {
                              z('raphael.anim.frame.' + e.id, e, i),
                                z('raphael.anim.finish.' + e.id, e, i),
                                I.is(t, 'function') && t.call(e);
                            });
                          })(i.callback, c, i.anim),
                          c.attr(u),
                          re.splice(e--, 1),
            ...
            (Ut.animateWith = function (t, e, i, r, n, s) {
              ...
              (Ut.onAnimation = function (t) {
                return (
                  t
                    ? z.on('raphael.anim.frame.' + this.id, t)
                    : z.unbind('raphael.anim.frame.' + this.id),
                  this
                );
              }),
              ...
              (Ut.setTime = function (t, e) {
                return (
                  t && null != e && this.status(t, L(e, t.ms) / t.ms), this
                );
              }),
              ...
              (Ut.pause = function (t) {
                for (var e = 0; e < re.length; e++)
                  re[e].el.id != this.id ||
                    (t && re[e].anim != t) ||
                    (!1 !==
                      z('raphael.anim.pause.' + this.id, this, re[e].anim) &&
                      (re[e].paused = !0));
                return this;
              }),
              (Ut.resume = function (t) {
                for (var e = 0; e < re.length; e++)
                  if (re[e].el.id == this.id && (!t || re[e].anim == t)) {
                    var i = re[e];
                    !1 !== z('raphael.anim.resume.' + this.id, this, i.anim) &&
              ...
              (Ut.stop = function (t) {
                for (var e = 0; e < re.length; e++)
                  re[e].el.id != this.id ||
                    (t && re[e].anim != t) ||
                    (!1 !==
                      z('raphael.anim.stop.' + this.id, this, re[e].anim) &&
                      re.splice(e--, 1));
                return this;
              }),
              z.on('raphael.remove', t),
              z.on('raphael.clear', t),
              ...
              pe = function (t) {
                if (
                  ...
                  for (var e = 0, i = t.length; e < i; e++)
                    !t[e] ||
                      (t[e].constructor != Ut.constructor &&
                        t[e].constructor != pe) ||
            ...
            for (var de in ((fe.push = function () {
              for (var t, e, i = 0, r = arguments.length; i < r; i++)
                !(t = arguments[i]) ||
                  (t.constructor != Ut.constructor && t.constructor != pe) ||
            ...
            return (
              ...
              (fe.splice = function (t, e, i) {
                (t = t < 0 ? M(this.length + t, 0) : t),
                  (e = M(0, L(this.length - t, e)));
                var r,
                  n = [],
                  s = [],
                  o = [];
                ...
                for (r = 0; r < a + n.length; r++)
                  this.items[t + r] = this[t + r] = r < a ? o[r] : n[r - a];
                for (r = this.items.length = this.length -= e - a; this[r]; )
                  delete this[r++];
                return new pe(s);
              }),
              ...
              (fe.animate = function (t, e, i, r) {
                ...
                for (n = this.items[--a].animate(l); a--; )
                  this.items[a] &&
                    !this.items[a].removed &&
                    this.items[a].animateWith(n, l, l),
                    (this.items[a] && !this.items[a].removed) || o--;
                return this;
              }),
              ...
              (fe.getBBox = function () {
                for (
                  var t = [], e = [], i = [], r = [], n = this.items.length;
                  n--;
              ...
              (e.print = function (t, e, i, r, n, s, o, a) {
                ...
                if ((I.is(r, 'string') && (r = this.getFont(r)), r)) {
                  ...
                  for (
                    var f = r.face.bbox[X](H),
                      d = +f[0],
                      g = f[3] - f[1],
                      x = 0,
                      v =
                        +f[1] + ('baseline' == s ? g + +r.face.descent : g / 2),
                      y = 0,
                      m = l.length;
                    y < m;
                    y++
                    ...
                    if ('\n' == l[y]) (c = w = u = 0), (x += g * a);
                      ...
                      var b = (c && r.glyphs[l[y - 1]]) || {},
                        w = r.glyphs[l[y]];
                      (u += c
                        ? (b.w || r.w) + ((b.k && b.k[l[y]]) || 0) + r.w * o
                        : 0),
                        (c = 1);
                    }
                    w &&
                      w.d &&
                      (p += I.transformPath(w.d, [
                        't',
                        u * h,
                        x * h,
                        's',
              ...
              (e.add = function (t) {
                if (I.is(t, 'array'))
                  for (var e, i = this.set(), r = 0, n = t.length; r < n; r++)
                    (e = t[r] || {}),
                      s[N](e.type) && i.push(this[e.type]().attr(e));
                return i;
              }),
              ...
              null == ae.readyState &&
                ...
                (ae.addEventListener(
                  he,
                  (le = function () {
                    ae.removeEventListener(he, le, !1),
                      (ae.readyState = 'complete');
                  }),
                  !1
                ),
                (ae.readyState = 'loading')),
              (function t() {
                /in/.test(ae.readyState)
                  ? setTimeout(t, 9)
                  : I.eve('raphael.DOMload');
              })(),
              I
            );
          }.apply(e, r)) || (t.exports = n);
      ...
      (p = 'hasOwnProperty'),
        ...
        ((y = function (t, e) {
          ...
          for (var c = (d = 0), p = s.length; c < p; c++)
            'zIndex' in s[c] &&
              (a.push(s[c].zIndex), s[c].zIndex < 0 && (h[s[c].zIndex] = s[c]));
          for (a.sort(x); a[o] < 0; )
        ...
        (y.listeners = function (t) {
          ...
          for (n = 0, s = l.length; n < s; n++) {
            for (h = [], o = 0, a = c.length; o < a; o++)
              for (i = [(u = c[o].n)[l[n]], u['*']], r = 2; r--; )
                (e = i[r]) && (h.push(e), (p = p.concat(e.f || [])));
            c = h;
          }
          return p;
        }),
        (y.on = function (t, e) {
          ...
          for (var i = t.split(g), r = v, n = 0, s = i.length; n < s; n++)
            r =
              ((r = r.n).hasOwnProperty(i[n]) && r[i[n]]) ||
              (r[i[n]] = { n: {} });
            ...
            if (t) {
              ...
              for (s = 0, o = l.length; s < o; s++)
                for (a = 0; a < u.length; a += n.length - 2) {
                  if (((n = [a, 1]), (i = u[a].n), '*' != l[s]))
                    i[l[s]] && n.push(i[l[s]]);
                  else for (r in i) i[p](r) && n.push(i[r]);
                  u.splice.apply(u, n);
                }
              for (s = 0, o = u.length; s < o; s++)
                for (i = u[s]; i.n; ) {
                  if (e) {
                    ...
                    for (r in (delete i.f, i.n))
                      i.n[p](r) && i.n[r].f && delete i.n[r].f;
                  i = i.n;
                }
            } else y._events = v = { n: {} };
          }),
        ...
        void 0 ===
          (n = function (S) {
            if (!S || S.svg) {
              ...
              var E = function (t, e) {
                  if (e)
                    for (var i in ('string' == typeof t && (t = E(t)), e))
                      e[B](i) &&
                        ('xlink:' == i.substring(0, 6)
                          ? t.setAttributeNS(F, i.substring(6), M(e[i]))
                          : t.setAttribute(i, M(e[i])));
                  else
                    (t = S._g.doc.createElementNS(
                ...
                P = function (t, e) {
                      ...
                      ((e = (e = M(e).replace(
                        ...
                        function (t, e, i) {
                          if (((n = 'radial'), e && i)) {
                            s = x(e);
                            var r = 2 * (0.5 < (o = x(i))) - 1;
                            0.25 < y(s - 0.5, 2) + y(o - 0.5, 2) &&
                              (o = v.sqrt(0.25 - y(s - 0.5, 2)) * r + 0.5) &&
                              0.5 != o &&
                              (o = o.toFixed(5) - 1e-5 * r);
                          }
                          return '';
                        }
                      )).split(/\s*\-\s*/)),
                      ...
                      for (var d = 0, g = f.length; d < g; d++)
                        l.appendChild(
                          E('stop', {
                            ...
                            'stop-opacity': isFinite(f[d].opacity)
                              ? f[d].opacity
                              : 1,
                          })
                        );
                  ...
                  return (
                    E(r, { fill: m(i), opacity: 1, 'fill-opacity': 1 }),
                    (h.fill = ''),
                    (h.opacity = 1),
                    (h.fillOpacity = 1)
                  );
                      ...
                      ((a =
                        'open' == g
                          ? ((x += 2),
                            ...
                            (s = 1),
                            (o = i ? 4 : 1),
                            { fill: 'none', stroke: p.stroke })
                          : ((o = s = x / 2),
                            { fill: p.stroke, stroke: 'none' })),
                      t._.arrows
                        ? i
                          ? (t._.arrows.endPath && A[t._.arrows.endPath]--,
                            t._.arrows.endMarker && A[t._.arrows.endMarker]--)
                          : (t._.arrows.startPath && A[t._.arrows.startPath]--,
                            t._.arrows.startMarker &&
                              A[t._.arrows.startMarker]--)
                        : (t._.arrows = {}),
                      'none' != g)
                    ) {
                      var m = 'raphael-marker-' + g,
                        b = 'raphael-marker-' + u + g + x + v + '-obj' + t.id;
                      S._g.doc.getElementById(m)
                        ? A[m]++
                        : (l.defs.appendChild(
                            E(E('path'), {
                              'stroke-linecap': 'round',
                          ...
                          (A[m] = 1));
                      var w,
                        _ = S._g.doc.getElementById(b);
                      _
                        ? (A[b]++, (w = _.getElementsByTagName('use')[0]))
                        : ((_ = E(E('marker'), {
                            id: b,
                            markerHeight: v,
                            markerWidth: x,
                          ...
                          (w = E(E('use'), {
                            ...
                            transform:
                              ...
                              v / y +
                              ')',
                            'stroke-width': (1 / ((x / y + v / y) / 2)).toFixed(
                              4
                            ),
                          })),
                          _.appendChild(w),
                          l.defs.appendChild(_),
                          (A[b] = 1)),
                        E(w, a);
                      var k = s * ('diamond' != g && 'oval' != g);
                      (n = i
                        ? ((r = t._.arrows.startdx * f || 0),
                          S.getTotalLength(p.path) - k * f)
                        : ((r = k * f),
                          S.getTotalLength(p.path) -
                            (t._.arrows.enddx * f || 0))),
                        ((a = {})['marker-' + u] = 'url(#' + b + ')'),
                        (n || r) && (a.d = S.getSubpath(p.path, r, n)),
                        E(c, a),
                        (t._.arrows[u + 'Path'] = m),
                        (t._.arrows[u + 'Marker'] = b),
                        (t._.arrows[u + 'dx'] = k),
                        (t._.arrows[u + 'Type'] = g),
                        (t._.arrows[u + 'String'] = e);
                    } else
                      (n = i
                        ? ((r = t._.arrows.startdx * f || 0),
                          S.getTotalLength(p.path) - r)
                        : ((r = 0),
                          S.getTotalLength(p.path) -
                            (t._.arrows.enddx * f || 0))),
                        t._.arrows[u + 'Path'] &&
                          E(c, { d: S.getSubpath(p.path, r, n) }),
                        delete t._.arrows[u + 'Path'],
                        delete t._.arrows[u + 'Marker'],
                        delete t._.arrows[u + 'dx'],
                        delete t._.arrows[u + 'Type'],
                        delete t._.arrows[u + 'String'];
                    for (a in A)
                      if (A[B](a) && !A[a]) {
                ...
                D = function (t, e, i) {
                  if ((e = a[M(e).toLowerCase()])) {
                    for (
                      ...
                      s[o] = e[o] * r + (o % 2 ? 1 : -1) * n;
                    E(t.node, { 'stroke-dasharray': s.join(',') });
                  } else E(t.node, { 'stroke-dasharray': 'none' });
                },
                f = function (t, e) {
                  var i = t.node,
                    r = t.attrs,
                    ...
                    if (e[B](s)) {
                      ...
                      switch (((r[s] = o), s)) {
                        ...
                        case 'clip-rect':
                          ...
                          if (4 == c.length) {
                            ...
                            (p.id = S.createUUID()),
                              ...
                              E(i, { 'clip-path': 'url(#' + p.id + ')' }),
                              (t.clip = f);
                          }
                          if (!o) {
                            var d = i.getAttribute('clip-path');
                            if (d) {
                              var g = S._g.doc.getElementById(
                                d.replace(/(^url\(#|\)$)/g, '')
                              );
                          ...
                          'path' == t.type &&
                            ...
                            t._.arrows &&
                              ('startString' in t._.arrows &&
                                I(t, t._.arrows.startString),
                              'endString' in t._.arrows &&
                                I(t, t._.arrows.endString, 1)));
                          break;
                        case 'width':
                          if ((i.setAttribute(s, o), (t._.dirty = 1), !r.fx))
                            break;
                          (s = 'x'), (o = r.x);
                        case 'x':
                        ...
                        case 'cx':
                          ...
                          break;
                        case 'height':
                          if ((i.setAttribute(s, o), (t._.dirty = 1), !r.fy))
                            break;
                          (s = 'y'), (o = r.y);
                        case 'y':
                        ...
                        case 'fill':
                          ...
                          if (x) {
                            ...
                            (p.id = S.createUUID()),
                              ...
                              E(v, { x: 0, y: 0, 'xlink:href': x[1] }),
                              p.appendChild(v),
                              (function (i) {
                                S._preload(x[1], function () {
                                  var t = this.offsetWidth,
                                    e = this.offsetHeight;
                                  E(i, { width: t, height: e }),
                                    E(v, { width: t, height: e });
                                });
                              })(p),
                              t.paper.defs.appendChild(p),
                              E(i, { fill: 'url(#' + p.id + ')' }),
                          ...
                          if (y.error) {
                            ...
                            delete e.gradient,
                              delete r.gradient,
                              !S.is(r.opacity, 'undefined') &&
                                S.is(e.opacity, 'undefined') &&
                                E(i, { opacity: r.opacity }),
                              !S.is(r['fill-opacity'], 'undefined') &&
                                S.is(e['fill-opacity'], 'undefined') &&
                                E(i, { 'fill-opacity': r['fill-opacity'] });
                          y[B]('opacity') &&
                            E(i, {
                              'fill-opacity':
                                1 < y.opacity ? y.opacity / 100 : y.opacity,
                            });
                        case 'stroke':
                          (y = S.getRGB(o)),
                        ...
                        case 'opacity':
                          r.gradient &&
                            !r[B]('stroke-opacity') &&
                            E(i, { 'stroke-opacity': 1 < o ? o / 100 : o });
                        case 'fill-opacity':
                          if (r.gradient) {
                            (m = S._g.doc.getElementById(
                              i.getAttribute('fill').replace(/^url\(#|\)$/g, '')
                            )) &&
                              ((b = m.getElementsByTagName('stop')),
                              E(b[b.length - 1], { 'stop-opacity': o }));
                            break;
                          }
                        default:
                ...
                R = function (t, e) {
                  if (
                    ...
                    var i = t.attrs,
                      ...
                      n = r.firstChild
                        ? _(
                            S._g.doc.defaultView
                              .getComputedStyle(r.firstChild, '')
                              .getPropertyValue('font-size'),
                            10
                          )
                        : 10;
                    if (e[B]('text')) {
                      for (i.text = e.text; r.firstChild; )
                      ...
                      for (
                        ...
                        (s = E('tspan')),
                          h && E(s, { dy: 1.2 * n, x: i.x }),
                          s.appendChild(S._g.doc.createTextNode(o[h])),
                          r.appendChild(s),
                          (a[h] = s);
                    } else
                      for (
                        h = 0, l = (a = r.getElementsByTagName('tspan')).length;
                        h < l;
                        h++
                      )
                        h
                          ? E(a[h], { dy: 1.2 * n, x: i.x })
                          : E(a[0], { dy: 0 });
                    E(r, { x: i.x, y: i.y }), (t._.dirty = 1);
                    var u = t._getBBox(),
                      c = i.y - (u.y + u.height / 2);
                    c && S.is(c, 'finite') && E(a[0], { dy: c });
                  }
                },
                r = function (t) {
                  return t.parentNode &&
                ...
                t = S.el;
              ((h.prototype = t).constructor = h),
                (S._engine.path = function (t, e) {
                  var i = E('path');
                  e.canvas && e.canvas.appendChild(i);
                  var r = new h(i, e);
                  return (
                    (r.type = 'path'),
                    f(r, { fill: 'none', stroke: '#000', path: t }),
                    r
                  );
                }),
                (t.rotate = function (t, e, i) {
                ...
                (t.translate = function (t, e) {
                  return (
                    this.removed ||
                      ((t = M(t).split(L)).length - 1 && (e = x(t[1])),
                      (t = x(t[0]) || 0),
                      (e = +e || 0),
                ...
                (t.transform = function (t) {
                  ...
                  if (
                    (S._extractTransform(this, t),
                    this.clip &&
                      E(this.clip, { transform: this.matrix.invert() }),
                    this.pattern && z(this),
                    this.node && E(this.node, { transform: this.matrix }),
                    1 != e.sx || 1 != e.sy)
                  ) {
                    var i = this.attrs[B]('stroke-width')
                ...
                (t.attr = function (t, e) {
                  ...
                  if (null == e && S.is(t, 'string')) {
                    ...
                    for (
                      var n = t.split(L), s = {}, o = 0, a = n.length;
                      o < a;
                      o++
                    )
                      (t = n[o]) in this.attrs
                        ? (s[t] = this.attrs[t])
                        : S.is(this.paper.customAttributes[t], 'function')
                        ? (s[t] = this.paper.customAttributes[t].def)
                        : (s[t] = S._availableAttrs[t]);
                    return a - 1 ? s : s[n[0]];
                  }
                  ...
                  for (var l in h)
                    p('raphael.attr.' + l + '.' + this.id, this, h[l]);
                  for (l in this.paper.customAttributes)
                    if (
                      this.paper.customAttributes[B](l) &&
                      h[B](l) &&
                      S.is(this.paper.customAttributes[l], 'function')
                    ) {
                      var u = this.paper.customAttributes[l].apply(
                        this,
                        [].concat(h[l])
                      );
                      for (var c in ((this.attrs[l] = h[l]), u))
                        u[B](c) && (h[c] = u[c]);
                    }
                ...
                (t.insertAfter = function (t) {
                  ...
                  return (
                    ...
                    S._insertafter(this, t, this.paper),
                    this
                  );
                }),
                (t.insertBefore = function (t) {
                  ...
                  return (
                    ...
                    S._insertbefore(this, t, this.paper),
                    this
                  );
                }),
                (t.blur = function (t) {
                  ...
                  if (0 != +t) {
                    ...
                    (e.attrs.blur = t),
                      (i.id = S.createUUID()),
                      E(r, { stdDeviation: +t || 1.5 }),
                      i.appendChild(r),
                      e.paper.defs.appendChild(i),
                      (e._blur = i),
                      E(e.node, { filter: 'url(#' + i.id + ')' });
                  } else
                    e._blur &&
                  ...
                  return (
                    ...
                    1 == e
                      ? ((a.style.cssText =
                          ...
                          r +
                          'px'),
                        S._g.doc.body.appendChild(a),
                        (o = 1))
                      : ((a.style.cssText = h + 'position:relative'),
                        e.firstChild
                          ? e.insertBefore(a, e.firstChild)
                          : e.appendChild(a)),
                    ((e = new S._Paper()).width = n),
                    (e.height = s),
                    (e.canvas = a),
                    e.clear(),
                    (e._left = e._top = 0),
                  ...
                  for (
                    s =
                      null == t
                        ...
                        : ((this._vbSize = h), t + ' ' + e + ' ' + i + ' ' + r),
                      E(this.canvas, { viewBox: s, preserveAspectRatio: u });
                    h && l;

                  )
                    (o =
                      'stroke-width' in l.attrs ? l.attrs['stroke-width'] : 1),
                      l.attr({ 'stroke-width': o }),
                      (l._.dirty = 1),
                      (l._.dirtyT = 1),
                      (l = l.prev);
                ...
                (S.prototype.clear = function () {
                  ...
                  (this.bottom = this.top = null),
                    (this.desc = E('desc')).appendChild(
                      S._g.doc.createTextNode(
                        'Created with Raphaël ' + S.version
                      )
                    ),
                    t.appendChild(this.desc),
                    t.appendChild((this.defs = E('defs')));
                }),
                (S.prototype.remove = function () {
                  for (var t in (p('raphael.remove', this),
            ...
            if (!E || E.vml) {
              var P = 'hasOwnProperty',
                ...
                y = function (t, e, i) {
                  var r = E.matrix();
                  return (
                    r.rotate(-t, 0.5, 0.5), { dx: r.x(e, i), dy: r.y(e, i) }
                  );
                },
                  ...
                  if (((u.visibility = 'hidden'), e && i)) {
                    ...
                    if (
                      ...
                      (x = x && x[0]),
                        l.removeChild(x),
                        h &&
                          ((g = y(s, a.x(h[0], h[1]), a.y(h[0], h[1]))),
                          (x.position = g.dx * c + Y + g.dy * c)),
                        o.fillsize &&
                          (x.size =
                            o.fillsize[0] * v(e) + Y + o.fillsize[1] * v(i)),
                        l.appendChild(x);
                    }
              ...
              var $,
                ...
                f = function (t, e) {
                  ...
                  if (
                    (s && ((r.path = E._getPath[t.type](t)), (t._.dirty = 1)),
                    e.href && (i.href = e.href),
                    e.title && (i.title = e.title),
                    e.target && (i.target = e.target),
                    e.cursor && (n.cursor = e.cursor),
                    'blur' in e && t.blur(e.blur),
                    ((e.path && 'path' == t.type) || s) &&
                      ((i.path = (function (t) {
                        var e = /[ahqstv]/gi,
                          i = E._pathToAbsolute;
                        if (
                          (z(t).match(e) && (i = E._path2curve),
                          (e = /[clmz]/g),
                          i == E._pathToAbsolute && !z(t).match(e))
                        ) {
                        ...
                        for (var a = 0, h = o.length; a < h; a++) {
                          (n = o[a]),
                            'z' == (s = o[a][0].toLowerCase()) && (s = 'x');
                          for (var l = 1, u = n.length; l < u; l++)
                            s += D(n[l] * X) + (l != u - 1 ? ',' : '');
                          r.push(s);
                        }
                        return r.join(Y);
                      })(
                        ~z(r.path).toLowerCase().indexOf('r')
                          ? E._pathToAbsolute(r.path)
                          : r.path
                      )),
                      (t._.dirty = 1),
                      'image' == t.type &&
                        ((t._.fillpos = [r.x, r.y]),
                        (t._.fillsize = [r.width, r.height]),
                        U(t, 1, 1, 0, 0, 0))),
                  ...
                  if ('clip-rect' in e) {
                    ...
                    if (4 == f.length) {
                      ...
                      var d = i.clipRect || E._g.doc.createElement('div'),
                        g = d.style;
                      (g.clip = E.format('rect({1}px {2}px {3}px {0}px)', f)),
                        i.clipRect ||
                          ((g.position = 'absolute'),
                          (g.top = 0),
                          (g.left = 0),
                    ...
                    e['clip-rect'] ||
                      (i.clipRect && (i.clipRect.style.clip = 'auto'));
                  }
                  if (t.textpath) {
                    var x = t.textpath.style;
                    e.font && (x.font = e.font),
                      e['font-family'] &&
                        (x.fontFamily =
                          '"' +
                          e['font-family']
                            ...
                            .replace(/^['"]+|['"]+$/g, '') +
                          '"'),
                      e['font-size'] && (x.fontSize = e['font-size']),
                      e['font-weight'] && (x.fontWeight = e['font-weight']),
                      e['font-style'] && (x.fontStyle = e['font-style']);
                  }
                  if (
                    ('arrow-start' in e && Z(a, e['arrow-start']),
                    'arrow-end' in e && Z(a, e['arrow-end'], 1),
                    null != e.opacity ||
                      null != e.fill ||
                      null != e.src ||
                      null != e.stroke ||
                    ...
                    if (
                      (!(v = v && v[0]) && (v = $(N)),
                      'image' == t.type && e.src && (v.src = e.src),
                      e.fill && (v.on = !0),
                      (null != v.on && 'none' != e.fill && null !== e.fill) ||
                        (v.on = !1),
                      v.on && e.fill)
                    ) {
                      var y = z(e.fill).match(E._ISURL);
                      if (y) {
                        v.parentNode == i && i.removeChild(v),
                          (v.rotate = !0),
                          (v.src = y[1]),
                          (v.type = 'tile');
                        var m = t.getBBox(1);
                        (v.position = m.x + Y + m.y),
                          (t._.fillpos = [m.x, m.y]),
                          E._preload(y[1], function () {
                            t._.fillsize = [
                              this.offsetWidth,
                              this.offsetHeight,
                            ];
                        ...
                        (v.color = E.getRGB(e.fill).hex),
                          (v.src = ''),
                          (v.type = 'solid'),
                          E.getRGB(e.fill).error &&
                    ...
                    if ('fill-opacity' in e || 'opacity' in e) {
                      var b =
                        ((+r['fill-opacity'] + 1 || 2) - 1) *
                        ((+r.opacity + 1 || 2) - 1) *
                        ((+E.getRGB(e.fill).o + 1 || 2) - 1);
                      (b = H(R(b, 0), 1)),
                        (v.opacity = b),
                        v.src && (v.color = 'none');
                    }
                    i.appendChild(v);
                    var w =
                        i.getElementsByTagName('stroke') &&
                        i.getElementsByTagName('stroke')[0],
                      _ = !1;
                    !w && (_ = w = $('stroke')),
                    ...
                    w.on && e.stroke && (w.color = k.hex),
                      (b =
                        ((+r['stroke-opacity'] + 1 || 2) - 1) *
                        ((+r.opacity + 1 || 2) - 1) *
                        ((+k.o + 1 || 2) - 1));
                    var C = 0.75 * (I(e['stroke-width']) || 1);
                    if (
                      ((b = H(R(b, 0), 1)),
                      null == e['stroke-width'] && (C = r['stroke-width']),
                      e['stroke-width'] && (w.weight = C),
                      C && C < 1 && (b *= C) && (w.weight = 1),
                      (w.opacity = b),
                      e['stroke-linejoin'] &&
                        (w.joinstyle = e['stroke-linejoin'] || 'miter'),
                      (w.miterlimit = e['stroke-miterlimit'] || 8),
                      e['stroke-linecap'] &&
                        (w.endcap =
                      ...
                      w.dashstyle = S[P](e['stroke-dasharray'])
                        ? S[e['stroke-dasharray']]
                        : '';
                    }
                    _ && i.appendChild(w);
                  }
                  if ('text' == a.type) {
                    ...
                    (n = B.style),
                      r.font && (n.font = r.font),
                      r['font-family'] && (n.fontFamily = r['font-family']),
                      r['font-weight'] && (n.fontWeight = r['font-weight']),
                      r['font-style'] && (n.fontStyle = r['font-style']),
                      (M = I(r['font-size'] || (M && M[0])) || 10),
                      (n.fontSize = 100 * M + 'px'),
                      a.textpath.string &&
                        (B.innerHTML = z(a.textpath.string)
                          .replace(/</g, '&#60;')
                          .replace(/&/g, '&#38;')
                          .replace(/\n/g, '<br>'));
                    var L = B.getBoundingClientRect();
                    (a.W = r.w = (L.right - L.left) / 100),
                      (a.H = r.h = (L.bottom - L.top) / 100),
                      (a.X = r.x),
                      (a.Y = r.y + a.H / 2),
                      ('x' in e || 'y' in e) &&
                        (a.path.v = E.format(
                ...
                Q = function (t, e, i) {
                      ...
                      function (t, e, i) {
                        return (
                          ...
                          e &&
                            ...
                            ((e = I(e)),
                            (i = I(i)),
                            0.25 < r(e - 0.5, 2) + r(i - 0.5, 2) &&
                              (i =
                                c.sqrt(0.25 - r(e - 0.5, 2)) *
                                  (2 * (0.5 < i) - 1) +
                                0.5),
                            (s = e + Y + i)),
                          ''
                  ...
                  if (((t = t.shape || t.node), a.length)) {
                    t.removeChild(i),
                      ...
                      (i.method = 'none'),
                      (i.color = a[0].color),
                      (i.color2 = a[a.length - 1].color);
                    for (var h = [], l = 0, u = a.length; l < u; l++)
                      a[l].offset && h.push(a[l].offset + Y + a[l].color);
                    (i.colors = h.length ? h.join() : '0% ' + i.color),
                      'radial' == n
                        ? ((i.type = 'gradientTitle'),
                          ...
                          (i.focusposition = s),
                          (i.angle = 0))
                        : ((i.type = 'gradient'), (i.angle = (270 - o) % 360)),
                      t.appendChild(i);
                  }
                  return 1;
                },
              ...
              ((d.prototype = t).constructor = d),
                (t.transform = function (t) {
                  ...
                  i &&
                    (e = t =
                      z(t).replace(/\.{3}|\u2026/g, this._.transform || '')),
                    E._extractTransform(this, r + t);
                  var n,
                    s = this.matrix.clone(),
                    o = this.skew,
                    a = this.node,
                  ...
                  if ((s.translate(1, 1), l || h || 'image' == this.type))
                    if (
                      ...
                      var u = this.getBBox(),
                        ...
                        p = u.x - c.x,
                        f = u.y - c.y;
                      (a.coordorigin = p * -X + Y + f * -X),
                        U(this, 1, 1, p, f, 0);
                    } else
                      (a.style.filter = ''),
                        U(this, n.scalex, n.scaley, n.dx, n.dy, n.rotate);
                  else
                    (a.style.filter = ''),
                      (o.matrix = z(s)),
                      (o.offset = s.offset());
                  return (
                    null !== e &&
                      ((this._.transform = e), E._extractTransform(this, e)),
                    this
                  );
                }),
                (t.rotate = function (t, e, i) {
                ...
                (t.translate = function (t, e) {
                  return (
                    this.removed ||
                      ((t = z(t).split(G)).length - 1 && (e = I(t[1])),
                      (t = I(t[0]) || 0),
                      (e = +e || 0),
                      this._.bbox &&
                ...
                (t.attr = function (t, e) {
                  ...
                  if (null == t) {
                    var i = {};
                    for (var r in this.attrs)
                      this.attrs[P](r) && (i[r] = this.attrs[r]);
                    return (
                      i.gradient &&
                        'none' == i.fill &&
                        (i.fill = i.gradient) &&
                  ...
                  if (null == e && E.is(t, 'string')) {
                    if (
                      ...
                      return this.attrs.gradient;
                    for (
                      var n = t.split(G), s = {}, o = 0, a = n.length;
                      o < a;
                      o++
                    )
                      (t = n[o]) in this.attrs
                        ? (s[t] = this.attrs[t])
                        : E.is(this.paper.customAttributes[t], 'function')
                        ? (s[t] = this.paper.customAttributes[t].def)
                        : (s[t] = E._availableAttrs[t]);
                    return a - 1 ? s : s[n[0]];
                  }
                  ...
                  var h;
                  for (var l in (null != e && ((h = {})[t] = e),
                  null == e && E.is(t, 'object') && (h = t),
                  h))
                    p('raphael.attr.' + l + '.' + this.id, this, h[l]);
                  if (h) {
                    for (l in this.paper.customAttributes)
                      if (
                        ...
                        h[P](l) &&
                        E.is(this.paper.customAttributes[l], 'function')
                      ) {
                        var u = this.paper.customAttributes[l].apply(
                          this,
                          [].concat(h[l])
                ...
                (t.insertAfter = function (t) {
                  return (
                    this.removed ||
                      (t.constructor == E.st.constructor &&
                        (t = t[t.length - 1]),
                      t.node.nextSibling
                ...
                (t.insertBefore = function (t) {
                  return (
                    this.removed ||
                      (t.constructor == E.st.constructor && (t = t[0]),
                ...
                (E._engine.image = function (t, e, i, r, n, s) {
                  ...
                  return (
                    ...
                    (h.path = o),
                    (a.type = 'image'),
                    u.parentNode == l && l.removeChild(u),
                    (u.rotate = !0),
                    (u.src = e),
                    (u.type = 'tile'),
                    (a._.fillpos = [i, r]),
                ...
                (E._engine.setSize = function (t, e) {
                  ...
                  return (
                    ...
                    (i.clip = 'rect(0 ' + t + ' ' + e + ' 0)'),
                    this._viewBox &&
                      E._engine.setViewBox.apply(this, this._viewBox),
                    this
                  );
                }),
                (E._engine.setViewBox = function (t, e, i, r, n) {
                  ...
                  return (
                    n &&
                      (i * (s = l / r) < h && (t -= (h - i * s) / 2 / s),
                      r * (o = h / i) < l && (e -= (l - r * o) / 2 / o)),
                ...
                (E.prototype.remove = function () {
                  for (var t in (E.eve('raphael.remove', this),
                  this.canvas.parentNode.removeChild(this.canvas),
                  this))
                    this[t] =
                      'function' == typeof this[t]
    ...
    (_ = window.Morris = {}),
        ...
        return (
          ...
          (t.prototype.fire = function () {
            ...
            if (
              ...
              null != this.handlers && null != this.handlers[i])
            ) {
              for (o = [], r = 0, n = (s = this.handlers[i]).length; r < n; r++)
                (e = s[r]), o.push(e.apply(null, t));
              return o;
            }
          }),
          t
      ...
      (_.commas = function (t) {
        ...
        return null != t
          ? ((r = t < 0 ? '-' : ''),
            (e = Math.abs(t)),
            (r += (i = Math.floor(e).toFixed(0)).replace(
              /(?=(?:\d{3})+$)(?!^)/g,
              ','
            )),
            (n = e.toString()).length > i.length && (r += n.slice(i.length)),
            r)
          : '-';
      }),
      (_.pad2 = function (t) {
      ...
      (_.Grid = (function (t) {
        function e(t) {
          ...
          if (
            ('string' == typeof t.element
              ? (this.el = x(document.getElementById(t.element)))
              : (this.el = x(t.element)),
          ...
          'static' === this.el.css('position') &&
              ...
              return (
                ...
                s.selectFrom
                  ? ((e = s.data[s.hitTest(Math.min(n, s.selectFrom))]._x),
                    (r = s.data[s.hitTest(Math.max(n, s.selectFrom))]._x - e),
                    s.selectionRect.attr({ x: e, width: r }))
            ...
            this.el.bind('touchstart touchmove touchend', function (t) {
              ...
              return (
                ...
                (e = s.el.offset()),
                s.fire('hovermove', i.pageX - e.left, i.pageY - e.top)
              );
            }),
            this.el.bind('click', function (t) {
              ...
              return (
                (e = s.el.offset()),
                s.fire('gridclick', t.pageX - e.left, t.pageY - e.top)
              );
            }),
            ...
            this.options.resize &&
              x(window).bind('resize', function (t) {
                return (
        ...
        return (
              ...
              null == (this.options.data = r) || 0 === r.length
                ...
                : ((f = this.cumulative ? 0 : null),
                  ...
                  0 < this.options.goals.length &&
                    ...
                    (d = null != d ? Math.min(d, i) : i),
                    (f = null != f ? Math.max(f, e) : e)),
                  (this.data = function () {
                    var t, e, i;
                    for (i = [], o = t = 0, e = r.length; t < e; o = ++t)
                      (h = r[o]),
                        ((a = { src: h }).label = h[this.options.xkey]),
                        this.options.parseTime
                          ? ((a.x = _.parseDate(a.label)),
                        ...
                        (a.y = function () {
                          ...
                          for (
                            ...
                            (p = i[s]),
                              'string' == typeof (g = h[p]) &&
                                (g = parseFloat(g)),
                              null != g && 'number' != typeof g && (g = null),
                              null != g &&
                                (this.cumulative
                                  ? (u += g)
                                  : null != f
                                  ? ((f = Math.max(g, f)), (d = Math.min(g, d)))
                                  : (f = d = g)),
                              this.cumulative &&
                                null != u &&
                                ((f = Math.max(u, f)), (d = Math.min(u, d))),
                              r.push(g);
                          return r;
                        }.call(this)),
                        i.push(a);
                  ...
                  0 < this.options.events.length &&
                    (this.options.parseTime
                      ? (this.events = function () {
                          var t, e, i, r;
                          for (
                            r = [], t = 0, e = (i = this.options.events).length;
                            t < e;
                            t++
                          )
                            (n = i[t]), r.push(_.parseDate(n));
                          return r;
                        }.call(this))
                  ...
                  (this.ymin = this.yboundary('min', d)),
                  (this.ymax = this.yboundary('max', f)),
                  this.ymin === this.ymax &&
                    (d && (this.ymin -= 1), (this.ymax += 1)),
                  (!0 !== (x = this.options.axes) &&
                    'both' !== x &&
                    'y' !== x &&
                    !0 !== this.options.grid) ||
                    ...
                    this.options.ymin === this.gridDefaults.ymin
                      ...
                      : ((l =
                          (this.ymax - this.ymin) /
                          (this.options.numLines - 1)),
                        (this.grid = function () {
                          var t, e, i;
                          for (
                            i = [], c = t = this.ymin, e = this.ymax;
                            0 < l ? t <= e : e <= t;
                            c = t += l
                          )
                            i.push(c);
          ...
          (e.prototype.yboundary = function (t, e) {
            var i, r;
            return 'string' == typeof (i = this.options['y' + t])
              ? 'auto' === i.slice(0, 4)
                ? 5 < i.length
                  ? ((r = parseInt(i.slice(5), 10)),
                    null == e ? r : Math[t](e, r))
                  : null != e
                  ? e
                  : 0
          ...
          (e.prototype.autoGridLines = function (t, e, i) {
            ...
            return (
              (o = e - t),
              (u = Math.floor(Math.log(o) / Math.log(10))),
              (h = Math.pow(10, u)),
              (n = Math.floor(t / h) * h),
              (r = Math.ceil(e / h) * h),
              (a = (r - n) / (i - 1)),
              1 === h &&
                1 < a &&
                Math.ceil(a) !== a &&
                ((a = Math.ceil(a)), (r = n + a * (i - 1))),
              n < 0 &&
                0 < r &&
                ((n = Math.floor(t / a) * a), (r = Math.ceil(e / a) * a)),
              a < 1
                ? ((s = Math.floor(Math.log(a) / Math.log(10))),
                  (function () {
                    var t, e;
                    for (e = [], l = t = n; 0 < a ? t <= r : r <= t; l = t += a)
                      e.push(parseFloat(l.toFixed(1 - s)));
                    return e;
                  })())
                : (function () {
                    var t, e;
            ...
            if (
              ...
              (this.elementWidth !== i ||
                ...
                (!0 !== (o = this.options.axes) && 'both' !== o && 'y' !== o) ||
                  ((s = function () {
                    var t, e, i, r;
                    for (r = [], t = 0, e = (i = this.grid).length; t < e; t++)
                      (n = i[t]),
                        r.push(this.measureText(this.yAxisFormat(n)).width);
                    return r;
                  }.call(this)),
                ...
                (!0 !== (a = this.options.axes) && 'both' !== a && 'x' !== a) ||
                  ...
                  (this.bottom -= Math.max.apply(Math, t))),
          ...
          (e.prototype.drawGoals = function () {
            var t, e, i, r, n, s, o;
            for (
              o = [], i = r = 0, n = (s = this.options.goals).length;
              r < n;
              i = ++r
            )
              (e = s[i]),
                ...
                o.push(this.drawGoal(e, t));
            return o;
          }),
          (e.prototype.drawEvents = function () {
            var t, e, i, r, n, s, o;
            for (
              o = [], i = r = 0, n = (s = this.events).length;
              r < n;
              i = ++r
            )
              (e = s[i]),
          ...
          (e.prototype.endRange = function (t) {
            ...
            if (this.selectFrom)
              return (
                (i = Math.min(this.selectFrom, t)),
                (e = Math.max(this.selectFrom, t)),
        ...
        return 'number' == typeof t
          ...
          : ((i = t.match(/^(\d+) Q(\d)$/)),
            ...
            i
              ...
              : a
              ? (4 !== (u = new Date(parseInt(a[1], 10), 0, 1)).getDay() &&
                  u.setMonth(0, 1 + ((4 - u.getDay() + 7) % 7)),
                u.getTime() + 6048e5 * parseInt(a[2], 10))
              : h
              ? h[6]
                ? ((o = 0),
                  'Z' !== h[6] &&
                    ((o = 60 * parseInt(h[8], 10) + parseInt(h[9], 10)),
                    '+' === h[7] && (o = 0 - o)),
                  Date.UTC(
                    parseInt(h[1], 10),
                    parseInt(h[2], 10) - 1,
              ...
              ? ((c = parseFloat(l[6])),
                (e = Math.floor(c)),
                (r = Math.round(1e3 * (c - e))),
                l[8]
                  ? ((o = 0),
                    'Z' !== l[8] &&
                      ((o = 60 * parseInt(l[10], 10) + parseInt(l[11], 10)),
                      '+' === l[9] && (o = 0 - o)),
                    Date.UTC(
                      parseInt(l[1], 10),
                      parseInt(l[2], 10) - 1,
      ...
      (_.Hover = (function () {
        function t(t) {
          null == t && (t = {}),
            (this.options = x.extend({}, _.Hover.defaults, t)),
            (this.el = x("<div class='" + this.options.class + "'></div>")),
            this.el.hide(),
            this.options.parent.append(this.el);
        }
        return (
          (t.defaults = { class: 'morris-hover morris-default-style' }),
          ...
          (t.prototype.moveTo = function (t, e) {
            ...
            return (
              ...
              (i = this.el.outerHeight()),
              (n = Math.min(Math.max(0, t - r / 2), o - r)),
              null != e
                ? (a = e - i - 10) < 0 &&
                  s < (a = e + 10) + i &&
                  (a = s / 2 - i / 2)
                : (a = s / 2 - i / 2),
              this.el.css({ left: n + 'px', top: parseInt(a) + 'px' })
            );
          }),
        ...
        return (
          ...
          (e.prototype.init = function () {
            if ('always' !== this.options.hideHover)
              return (
                (this.hover = new _.Hover({ parent: this.el })),
          ...
          (e.prototype.calcPoints = function () {
            var n, s, t, e, i, r;
            for (r = [], t = 0, e = (i = this.data).length; t < e; t++)
              ((n = i[t])._x = this.transX(n.x)),
                (n._y = function () {
                  var t, e, i, r;
                  for (r = [], t = 0, e = (i = n.y).length; t < e; t++)
                    null != (s = i[t]) ? r.push(this.transY(s)) : r.push(s);
                  return r;
                }.call(this)),
                r.push(
                  (n._ymax = Math.min.apply(
                    ...
                    [this.bottom].concat(
                      (function () {
                        var t, e, i, r;
                        for (r = [], t = 0, e = (i = n._y).length; t < e; t++)
                          null != (s = i[t]) && r.push(s);
                        return r;
                      })()
                    )
          ...
          (e.prototype.onGridClick = function (t, e) {
            ...
            return (
              (i = this.hitTest(t)),
              this.fire('click', i, this.data[i].src, t, e)
            );
          }),
          ...
          (e.prototype.hoverContentForRow = function (t) {
            ...
            return (
              'function' == typeof this.options.hoverCallback &&
                (e = this.options.hoverCallback(t, this.options, e, r.src)),
              [e, r._x, r._ymax]
            );
          }),
          (e.prototype.generatePaths = function () {
            ...
            return (this.paths = function () {
              var t, e, i, r;
              for (
                r = [], s = t = 0, e = this.options.ykeys.length;
                0 <= e ? t < e : e < t;
                s = 0 <= e ? ++t : --t
              )
                (a =
                  ...
                  (n = function () {
                    ...
                    for (r = [], t = 0, e = (i = this.data).length; t < e; t++)
                      void 0 !== (o = i[t])._y[s] &&
                        r.push({ x: o._x, y: o._y[s] });
                    return r;
                  }.call(this)).length
                    ? r.push(_.Line.createPath(n, a, this.bottom))
                    : r.push(null);
              return r;
            }.call(this));
          }),
          ...
          (e.prototype.drawXAxis = function () {
            var t,
              ...
              u = this;
            for (
              l = this.bottom + this.options.padding / 2,
                a = h = null,
                t = function (t, e) {
                  var i, r, n, s, o;
                  return (
                    (o = (i = u.drawXAxisLabel(u.transX(e), l, t)).getBBox()),
                    i.transform('r' + -u.options.xLabelAngle),
                    (r = i.getBBox()),
                    i.transform('t0,' + r.height / 2 + '...'),
                    0 !== u.options.xLabelAngle &&
                      ((s =
                        -0.5 *
                        o.width *
                        Math.cos((u.options.xLabelAngle * Math.PI) / 180)),
                      i.transform('t' + s + ',0...')),
                    (r = i.getBBox()),
                    (null == h ||
                      h >= r.x + r.width ||
                      (null != a && a >= r.x)) &&
                    0 <= r.x &&
                    r.x + r.width < u.el.width()
                      ? (0 !== u.options.xLabelAngle &&
                          ((n =
                            (1.25 * u.options.gridTextSize) /
                            Math.sin((u.options.xLabelAngle * Math.PI) / 180)),
                          (a = r.x - n)),
                        (h = r.x - u.options.xLabelMargin))
                      : i.remove()
                  );
                },
                (i = this.options.parseTime
                  ...
                  : function () {
                      var t, e, i, r;
                      for (
                        r = [], t = 0, e = (i = this.data).length;
                        t < e;
                        t++
                      )
                        (n = i[t]), r.push([n.label, n.x]);
                      return r;
                    }.call(this)).reverse(),
                o = [],
                r = 0,
          ...
          (e.gradients = function (t) {
            ...
            for (
              ...
              null != (e = t[r]).y
                ? ((n = t[r + 1] || { y: null }),
                  null != (s = t[r - 1] || { y: null }).y && null != n.y
                    ? h.push(i(s, n))
                    : null != s.y
                    ? h.push(i(s, e))
                    : null != n.y
      ...
      (_.labelSeries = function (t, e, i, r, n) {
        var s, o, a, h, l, u, c, p, f, d, g;
        if (
          ((a = (200 * (e - t)) / i),
          (o = new Date(t)),
          void 0 === (c = _.LABEL_SPECS[r]))
        )
        ...
        for (
          void 0 === c && (c = _.LABEL_SPECS.second),
            n && (c = x.extend({}, c, { fmt: n })),
            s = c.start(o),
            l = [];
          (p = s.getTime()) <= e;

        )
          t <= p && l.push([c.fmt(s), p]), c.incr(s);
        return l;
      }),
      (t = function (e) {
        return {
      ...
      (_.Area = (function (t) {
        ...
        function r(t) {
          ...
          (e = x.extend({}, i, t)),
            (this.cumulative = !e.behaveLikeLine),
            'auto' === e.fillOpacity &&
              (e.fillOpacity = e.behaveLikeLine ? 0.8 : 1),
            r.__super__.constructor.call(this, e);
        }
        return (
          s(r, t),
          (i = { fillOpacity: 'auto', behaveLikeLine: !1 }),
                  ...
                  for (r = [], t = 0, e = (i = n.y).length; t < e; t++)
                    (o = i[t]),
                      this.options.behaveLikeLine
                        ? r.push(this.transY(o))
                        : ((s += o || 0), r.push(this.transY(s)));
                  return r;
                }.call(this)),
                r.push((n._ymax = Math.max.apply(Math, n._y)));
            return r;
          }),
          (r.prototype.drawSeries = function () {
            ...
            for (
              this.seriesPoints = [],
                a = [],
                i = 0,
                r = (e = this.options.behaveLikeLine
                  ? function () {
                      s = [];
                      for (
          ...
          (r.prototype.fillForSeries = function (t) {
            var e;
            return (
              (e = Raphael.rgb2hsl(this.colorFor(this.data[t], t, 'line'))),
              Raphael.hsl(
                e.h,
                this.options.behaveLikeLine ? 0.9 * e.s : 0.75 * e.s,
                Math.min(
                  0.98,
                  this.options.behaveLikeLine ? 1.2 * e.l : 1.25 * e.l
                )
              )
            );
          }),
      ...
      (_.Bar = (function (t) {
        function e(t) {
          if (
            ...
            (this.onHoverMove = u(this.onHoverMove, this)),
            (this.onGridClick = u(this.onGridClick, this)),
            !(this instanceof _.Bar))
          )
            return new _.Bar(t);
          e.__super__.constructor.call(
            this,
            x.extend({}, t, { parseTime: !1 })
          );
        }
        return (
          s(e, t),
          ...
          (e.prototype.calcBars = function () {
            var t, n, s, e, i, r, o;
            for (o = [], t = e = 0, i = (r = this.data).length; e < i; t = ++e)
              ((n = r[t])._x =
                this.left + (this.width * (t + 0.5)) / this.data.length),
                o.push(
                  (n._y = function () {
                    var t, e, i, r;
                    for (r = [], t = 0, e = (i = n.y).length; t < e; t++)
                      null != (s = i[t])
                        ? r.push(this.transY(s))
                        : r.push(null);
                    return r;
                  }.call(this))
                );
          ...
          (e.prototype.drawXAxis = function () {
            ...
            for (
              ...
              (a = this.data[this.data.length - 1 - t]),
                (h = (e = this.drawXAxisLabel(a._x, l, a.label)).getBBox()),
                ...
                0 !== this.options.xLabelAngle &&
                  ...
                  e.transform('t' + n + ',0...')),
                (null == o || o >= i.x + i.width || (null != s && s >= i.x)) &&
                0 <= i.x &&
                i.x + i.width < this.el.width()
                  ? (0 !== this.options.xLabelAngle &&
                      ((r =
                        (1.25 * this.options.gridTextSize) /
                        Math.sin((this.options.xLabelAngle * Math.PI) / 180)),
                      (s = i.x - r)),
                    p.push((o = i.x - this.options.xLabelMargin)))
                  : p.push(e.remove());
            return p;
          }),
          (e.prototype.drawSeries = function () {
            ...
            return (
              (o = this.width / this.options.data.length),
              (t = this.options.stacked ? 1 : this.options.ykeys.length),
              (n =
                (o * this.options.barSizeRatio -
                  this.options.barGap * (t - 1)) /
                t),
              this.options.barSize && (n = Math.min(n, this.options.barSize)),
              (e = o - n * t - this.options.barGap * (t - 1)),
              (u = e / 2),
              (x = this.ymin <= 0 && 0 <= this.ymax ? this.transY(0) : null),
              (this.bars = function () {
                var t, e, i, r;
                for (
                  i = this.data, r = [], a = t = 0, e = i.length;
                  t < e;
                  a = ++t
                )
                  (c = i[a]),
                    ...
                    r.push(
                      function () {
                        var t, e, i, r;
                        for (
                          i = c._y, r = [], p = t = 0, e = i.length;
                          t < e;
                          p = ++t
                        )
                          null !== (g = i[p])
                            ? ((s = x
                                ? ((d = Math.min(g, x)), Math.max(g, x))
                                : ((d = g), this.bottom)),
                              (l = this.left + a * o + u),
                              this.options.stacked ||
                                (l += p * (n + this.options.barGap)),
                              (f = s - d),
                              this.options.verticalGridCondition &&
                                this.options.verticalGridCondition(c.x) &&
                                this.drawBar(
                                  this.left + a * o,
                                  this.top,
                                  o,
                              ...
                              this.options.stacked && (d -= h),
                              this.drawBar(
                                l,
                                d,
                                n,
                                f,
                                this.colorFor(c, p, 'bar'),
          ...
          (e.prototype.colorFor = function (t, e, i) {
            ...
            return 'function' == typeof this.options.barColors
              ? ((r = { x: t.x, y: t.y[e], label: t.label }),
                (n = {
                  index: e,
                  key: this.options.ykeys[e],
                  label: this.options.labels[e],
                }),
                this.options.barColors.call(this, r, n, i))
          ...
          (e.prototype.onHoverMove = function (t, e) {
            ...
            return (
              (i = this.hitTest(t)),
              (r = this.hover).update.apply(r, this.hoverContentForRow(i))
            );
          }),
          (e.prototype.onHoverOut = function () {
          ...
          (e.prototype.hoverContentForRow = function (t) {
            ...
            return (
              'function' == typeof this.options.hoverCallback &&
                (e = this.options.hoverCallback(t, this.options, e, r.src)),
              [e, this.left + ((t + 0.5) * this.width) / this.data.length]
            );
          }),
          (e.prototype.drawXAxisLabel = function (t, e, i) {
            return this.raphael
      ...
      (_.Donut = (function (t) {
        function e(t) {
          ...
          if (
            ((this.options = x.extend({}, this.defaults, t)),
            'string' == typeof t.element
              ? (this.el = x(document.getElementById(t.element)))
              : (this.el = x(t.element)),
            null === this.el || 0 === this.el.length)
        ...
        return (
          ...
          (e.prototype.redraw = function () {
            ...
            for (
              a = 5 / (2 * c),
                ...
                this.segments = [],
                r = f = 0,
                x = (m = this.values).length;
              f < x;
              r = ++f
            )
              (h = s + a + t * (m[r] / u)),
                (l = new _.DonutSegment(
                  e,
                  i,
                  2 * c,
                  c,
          ...
          (e.prototype.setData = function (t) {
            ...
            return (
              ...
              (this.values = function () {
                var t, e, i, r;
                for (r = [], t = 0, e = (i = this.data).length; t < e; t++)
                  (n = i[t]), r.push(parseFloat(n.value));
                return r;
              }.call(this)),
              this.redraw()
            );
          ...
          (e.prototype.select = function (t) {
            var e, i, r, n;
            for (i = 0, r = (n = this.segments).length; i < r; i++)
              n[i].deselect();
            return (
              this.segments[t].select(),
              (e = this.data[t]),
              this.setLabels(e.label, this.options.formatter(e.value, e))
            );
          }),
          (e.prototype.setLabels = function (t, e) {
            ...
            return (
              (s =
                ...
                (i =
                  (2 *
                    (Math.min(this.el.width() / 2, this.el.height() / 2) -
                      10)) /
                  3)),
              (n = i / 2),
              (r = i / 3),
              ...
              (a = Math.min(s / o.width, n / o.height)),
              this.text1.attr({
                transform:
                  'S' +
                  a +
              ...
              (l = Math.min(s / h.width, r / h.height)),
              this.text2.attr({
                transform:
                  'S' + l + ',' + l + ',' + (h.x + h.width / 2) + ',' + h.y,
              })
            );
          }),
      ...
      (_.DonutSegment = (function (t) {
        ...
        return (
          s(e, t),
          (e.prototype.calcArcPoints = function (t) {
            return [
          ...
          (e.prototype.calcSegment = function (t, e) {
            ...
            return (
              (i = (u = this.calcArcPoints(t))[0]),
              (n = u[1]),
              (r = u[2]),
              (s = u[3]),
              (o = (c = this.calcArcPoints(e))[0]),
              (h = c[1]),
              (a = c[2]),
              (l = c[3]),
              'M' +
