  ...
  ($.AdminOreo.leftSideBar = {
    activate: function () {
      ...
      $(window).on('click', function (e) {
        ...
        'i' === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()),
          !a.hasClass('bars') &&
            i.isOpen() &&
            0 === a.parents('#leftsidebar, .mini-sidebar').length &&
            (a.hasClass('js-right-sidebar') || o.fadeOut(),
        ...
        $('.menu-toggle').on('click', function (e) {
          ...
          if ($(a.parents('ul')[0]).hasClass('list')) {
            var t = $(e.target).hasClass('menu-toggle')
              ? e.target
    ...
    checkStatuForResize: function (e) {
      ...
      e &&
        ...
        t < 1170
          ? (a.addClass('ls-closed'), i.fadeIn())
          : (a.removeClass('ls-closed'), i.fadeOut());
    },
    isOpen: function () {
      ...
      $(window).on('click', function (e) {
        ...
        'i' === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()),
          !a.hasClass('js-right-sidebar') &&
            ...
            (a.hasClass('bars') || o.fadeOut(), t.removeClass('open'));
      }),
...
!(function () {
  ...
  (e.async = !0),
    (e.src = 'https://embed.tawk.to/59f5afbbbb0c3f433d4c5c4c/default'),
    (e.charset = 'UTF-8'),
